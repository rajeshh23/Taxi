...
export default class HomeScreen extends Component{
    browser='chrome';
     constructor(props){
         ...
         this.handleUniversalClickOutside = this.handleUniversalClickOutside.bind(this);
         this.state={
             browser:'chrome',
             mouse:false,
             index:-1,
     ...
     componentDidMount(){
         this.subMenulist=[
             {
                 Menu:"Scheduling",
                 List:[{id:"Schedule Media Files","key":SchedFile},{id:"Define Geo-Zones","key":GeoZone}]
             },
             {
                 Menu:"Manage Cabs",
                 List:[{id:"Cab Details","key":CabDetails},{id:"Cab Association","key":CabAssociation}],
             },
             {
                 Menu:"Manage Files",
                 List: [{id:"Media Files","key":MediaFiles},{id:"System Files","key":SystemFiles}],
             },
             {
                 Menu:"Reports",
                 List:[{id:"Play Log","key":PlayLogs},{id:"Play Log Statistics","key":Statistics},{id:"Global Index Report","key":GlobleIndex},{id:"User Dashbord","key":UserDash},{id:"Admin Dashbord","key":TableGrid}],
             },
             {
                 Menu:"Transfer",
                 List:[{id:"In-Progress","key":InProgress},{id:"Upload Queue","key":Queue},{id:"Transferred Contents","key":TransferContent}],
             },
             {
             ...
             {
                 Menu:"Settings",
                 List:[{id:"Change Password","key":"changePass"},{id:"About","key":"about"}],
             }
         ]
         ...
         this.setState({marketName:sessionStorage.getItem("marketName"),marketId:sessionStorage.getItem("marketId")});
         ...
         if (info) {
             ...
             if (info.Permission) {
                 ...
                 console.log("hk;dgkh;lkghkdghkd'hkdl'kfh'dlkgh'dkh'kdh'kd'k'dkh'k",pjsonData);
                 subMenulist = [];
                 console.log("json is ", pjsonData)
                 if (pjsonData && pjsonData.permissions && pjsonData.permissions.mainMenu && pjsonData.permissions.mainMenu.root && pjsonData.permissions.mainMenu.root.menuitem && pjsonData.permissions.mainMenu.root.menuitem.length > 0) {
                             ...
                             if (item.menuitem && item.menuitem.length > 0) {
                                 ...
                                 if (item["@label"] == "manage_cabs_menu") {
                                     ...
                                     item.menuitem.forEach(function (subitem) {
                                         ...
                                         if ((sessionStorage.getItem("marketId")==="DTTU"|| sessionStorage.getItem("marketId")==="MX925" || sessionStorage.getItem("marketId")==="GLACIER" ) && subitem["@label"] == "remote_monitoring") {
                                            list.push(
                                                {id: "Remote Monitoring", "key": RemoteMonitoring}
                                            )
                                        }
                                     });
                                     obj.List = list;
                                 ...
                                 if (item["@label"] == "administration_tools") {
                                     ...
                                     item.menuitem.forEach(function (subitem) {
                                         ...
                                         if (subitem["@label"] == "user_management") {
                                             list.push(
                                                 {id: "User Management", "key": ManageUser}
                                             )
                                         }
                                     });
                                     obj.List = list;
    ...
    GetPage=(val)=>{
      if(val.key === "changePass"){
        ...
        var Comp = val.key
        if(Comp){
          this.setState({nav:<Comp></Comp>,compName:val.id,Menu:subMenulist[this.state.index].Menu})
        }else{
     ...
     getServerTime(){
         ...
         getData("UserMgmt/GetServerTime")
             .then(res=>{
    ...
    SubMenu =()=>{
      return(
        <div className="nav__submenu">
         {
           subMenulist[this.state.index] && subMenulist[this.state.index].List.map((key,index)=>(
           <div className="nav__submenu-item" onClick={()=>this.GetPage(key)} key={index}>{key.id}</div>
           ))
         }
      </div>
      )
            ...
            <div style={{height:'100vh',backgroundColor:"#232323"}}>
              {
                      ...
                      <div className="HomeScrChangePassMainWrp">
                          ...
                          <div style={{marginTop:"30px"}}>
                              <div className="LoginInptChildWrp">
                                  ...
                                  <input className="LoginInputFld" onChange={(e)=>this.setState({oldPass:e.target.value})} autoComplete="on"></input>
                              </div>
                              <div className="LoginInptChildWrp">
                                  <div className="HomeScrChngPasstxt1">New Password *</div>
                                  <input className="LoginInputFld" type="password" onChange={(e)=>this.setState({newPass:e.target.value})} autoComplete="on"></input>
                              </div>
                              <div className="LoginInptChildWrp">
                          ...
                          <div className="HomeSrcChngPassBtm">
                              ...
                              <img src={require("../Assets/Images/Login/cancel-btn.png")} className="ForgPassBtn" onClick={()=>this.setState({changePass:false})}></img>
                          </div>
                      </div>
                  </div>
              }
                <div className="HomeTopWrp">
                    <div className="HomeTopSideWrp" style={{width:"23%"}}>
                        ...
                        <div className="HomeTopTabWrp" style={{"display":"block","text-align":"center"}}>
                            <img src={require("../Assets/Images/logo2.png")} className="HomeLogoWrp" style={{width:"62%"}}></img>
                        </div>
                    ...
                    <div className="HomeTopSideWrp">
                      {
                        Object.keys(this.state.userInfo).length > 0 && this.state.userInfo.constructor === Object &&
                        <div className="HomeTopCredWrp">
                            <div className="HomeTopCredTxt">{this.state.marketName}</div>
                            <img src={require("../Assets/Images/separator.png")} className="HomeTopCredSeprtr"></img>
                      <div className="HomeTopCredTxt">Server Time: {this.state.serverDate}</div>
                            <img src={require("../Assets/Images/separator.png")} className="HomeTopCredSeprtr"></img>
                            <div className="HomeTopCredTxt">Welcome :{this.state.userInfo.FirstName} {this.state.userInfo.LastName}</div>
                            <img src={require("../Assets/Images/separator.png")} className="HomeTopCredSeprtr"></img>
                            <div className="HomeTopCredTxt" style={{cursor:"pointer"}} onClick={()=>this.logout()}>Logout</div>
                        </div>
                      }
                        <div className="HomeTopTabWrp">
                            <div className="HomeTabIndWrp">
                                <div className={this.browser=="safari"?"HometanIndwrp2":"HometanIndwrp1"}>
                            ...
                            <div className="HomeTabImgWrp">
                                <div className="HomeTabNameWrp">
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(0)} onMouseLeave={()=>this.setState({index:-1})}>
                                    ...
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(1)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                        <div>Manage Cabs</div>
                                        {
                                        this.state.index === 1 &&
                                    ...
                                    <div className="HomeTabtxt1">|</div>
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(2)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                    ...
                                    <div className="HomeTabtxt1">|</div>
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(3)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                        <div>Reports</div>
                                        {
                                        this.state.index === 3 &&
                                    ...
                                    <div className="HomeTabtxt1">|</div>
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(4)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                        <div>Transfer</div>
                                        {
                                        this.state.index === 4 &&
                                    ...
                                    <div className="HomeTabtxt1">|</div>
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(5)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                    ...
                                    <div className="HomeTabtxt1">|</div>
                                    <div className="HomeTabTxtWrp" onMouseEnter={()=>this.setSubMenue(6)} onMouseLeave={()=>this.setState({index:-1})}>
                                      <div className="HomeTabtxt">
                                        <div>Settings</div>
                                        {
                                        this.state.index === 6 &&
                                ...
                                <img src={require("../Assets/Images/tab-menu-bg.jpg")} className={this.browser==="safari"?"HomeTabImg1":"HomeTabImg"}></img>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="Loader">
                    <div className="HomeScrChangePassMainWrp aboutmain">
                        <div className="ForgPassTitle ShedTitle">
                            <div style={{"width":"96%"}}>About Media Management Portal
                            </div>
                            <div className="ShedHide" onClick={()=>this.setState({about:false})}>X
                            </div>
                        </div>
