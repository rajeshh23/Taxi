...
export default class ManageUser extends Component {
  ...
  getRecord() {
    ...
    getData("UserMgmt/FetchUsers").then((res) => {
  ...
  setUser() {
    ...
    if (this.state.addUserPop === 1) {
      ...
      postData("UserMgmt/AddUser", obj).then((res) => {
      ...
      putData("UserMgmt/EditUser", obj).then((res) => {
        if (res.data && res.data.ReturnCode == 0) {
          this.getRecord();
        } else {
          this.setState({ loading: false });
  ...
  deleteUser(value) {
    if (value === "Confirm") {
      ...
      if (this.state.delete && this.state.delete.length > 0) {
        ...
        postData("UserMgmt/DeleteUser", obj).then((res) => {
          if (res.data && res.data.ReturnCode === 0) {
            this.getRecord();
          } else {
            this.setState({ loading: false });
      ...
      <div>
            ...
            <div className="addUserMainWrp userpop" style={{ height: "350px" }}>
              ...
              <div style={{ marginTop: "30px" }}>
                <div className="LoginInptChildWrp">
                  ...
                  <input
                    className="LoginInputFld userMgmfield"
                    onChange={(e) => this.setFields(e.target.value, "userName")}
                ...
                <div className="LoginInptChildWrp">
                  ...
                  <input
                    className="LoginInputFld userMgmfield"
                    onChange={(e) => this.setFields(e.target.value, "email")}
                    autoComplete="on"
                ...
                <div className="LoginInptChildWrp">
                  ...
                  <input
                    className="LoginInputFld userMgmfield"
                    onChange={(e) => this.setFields(e.target.value, "fName")}
                    autoComplete="on"
                ...
                <div className="LoginInptChildWrp">
                  ...
                  <input
                    className="LoginInputFld userMgmfield"
                    onChange={(e) => this.setFields(e.target.value, "lName")}
                    autoComplete="on"
                ...
                <div className="LoginInptChildWrp">
                  ...
                  <div className="userMgmfield">
                    <select
                      ...
                      style={{ width: "75%" }}
                      onChange={(e) =>
                        this.setFields(e.target.value, "grpName")
                      }
                ...
                <div className="LoginInptChildWrp">
                  ...
                  <div className="requiredField" style={{ width: "2%" }}>
                    {" "}
                  </div>
                  <div className="userMgmfield">
                    <select
        ...
        <div className="TableBorder">
          ...
          <div className="ScheduleTabToolWrp">
            <img
              src={require("../../../Assets/Images/User/add-user.png")}
              className="ScheduleupldImg"
              onClick={() => this.setState({ addUserPop: 1 })}
            ></img>
            <img
              src={require("../../../Assets/Images/User/delete-user.png")}
              className="ScheduleupldImg"
              onClick={() => this.deleteUser("Confirm")}
            ></img>
