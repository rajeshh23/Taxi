...
export default class TableGrid extends Component {
  ...
  uploadFileExt = ".avi,.jpg,.jpeg,.gif,.png,.swf";
    ...
    colData.map((key, index) => {
      ...
      if (key.accessor === "FileType") {
        ...
        obj = {
          ...
          Cell: (rowInfo) => (
            <div>
              {rowInfo.original.FileGroups &&
                rowInfo.original.FileGroups.length > 0 && (
                  <div>
                    {rowInfo.original.FileGroups.map((key, index) => {
                      if (index === rowInfo.original.FileGroups.length - 1) {
    ...
    if (this.state.group === true) {
      ...
      postData(url, obj).then((res) => {
        if (res && res.data && res.data.ResponseCollection) {
          this.setState(
            {
              data: res.data.ResponseCollection[0],
              flLoading: false,
              deletData: [],
            },
            () => {
          ...
          this.setState({ data: [], flLoading: false, deletData: [] });
        }
      });
    }
  }
  ...
  setLoadFile(data) {
    if (this.filterType === 1) {
      if (this.state.schedVideo) {
        ...
        this.addobj.Resolution = data.Resolution;
      } else {
      ...
      if (this.state.schedVideo) {
        ...
        this.state.flEditData.B2 = data.FileID;
      }
      ...
      if (this.state.schedVideo) {
        ...
        this.state.flEditData.B1 = data.FileID;
      }
    }
        ...
        arrGroupADSL_VideoVO: [
          {
            ...
            B1: this.state.flEditData.B1,
            B2: this.state.flEditData.B2,
  ...
  editLoadFile() {
    ...
    if (type === 0 && this.state.flEditData.WebVisibleURL === "") {
      ...
      if (this.state.typeL != "3" || this.state.typeL != "2") {
    ...
    if (msg === "") {
      ...
      let obj = {};
      this.state.timeEndhr = this.setDigit(this.state.timeEndhr);
      this.state.timeEndmin = this.setDigit(this.state.timeEndmin);
      this.state.timeSrthr = this.setDigit(this.state.timeSrthr);
      this.state.timeSrtmin = this.setDigit(this.state.timeSrtmin);
      if (this.state.editGrFile) {
        if (this.state.flEditData.FileType == 0) {
          obj = {
          ...
          obj = {
            editGROUP_ADSFL_Banner: {
              ...
              TimeEnd: this.state.timeEndhr + this.state.timeEndmin,
              FileId_V: this.state.flEditData.B1,
              FileId_H: this.state.flEditData.B2,
  ...
  schedValid(type) {
    ...
    if (type === 0 && this.addobj.WebVisibleURL === "") {
      ...
      if (this.state.typeL !== "3" && this.state.typeL !== "2") {
        if (this.addobj.Resolution == "16:9") {
          msg = "Please Select Horizontal Banner";
        }
      }
    } else if (
      ...
      if (this.state.typeL !== "3" && this.state.typeL !== "2") {
        if (this.addobj.Resolution == "4:3") {
          msg =
            "Horizontal Banner cannot be associated with videos with ratio 4:3";
        }
      }
    }
        ...
        arrGroupADSL_VideoVO: [
          {
            ...
            TIMESTART: this.state.timeSrthr + this.state.timeSrtmin,
            FULLSCR_NG: this.state.fScreen,
            B1: this.addobj.Banner1,
            B2: this.addobj.Banner2,
    ...
    return (
      <div>
        {this.state.loading ? (
            ...
            <div className="SchedBnrWrp" draggable={true}>
              ...
              <div className="SchedEdtFileTopWrp">
                ...
                >
                  ...
                  {this.state.typeL === 3 ||
                    (this.state.typeL === "3" && (
                      <div className="SchedDisbleWrp" disabled={true}></div>
                    ))}
                </div>
                <div
                  className="SchedEdtFileTopChild"
          ...
          <div className="Loader">
            <div className="SchedBnrWrpmx925" draggable={true}>
              <div className="ForgPassTitle ShedTitle">
                <div style={{ width: "96%" }}>Media Scheduling</div>
                <div className="ShedHide" onClick={() => this.resetFlDetails()}>
                  X
                      ...
                      if (e.target.value == 3 || e.target.value == 2) {
                        if (this.addobj.B2 > 0) {
                          this.setState({
                            dlgtitle: "Information",
                            message:
                              "Banner can not associated with goodby loop or welcome loop",
                            dlgType: "information",
                            schedVal: true,
                          });
                        }
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        if (e.target.value == 3) {
                          ...
                          this.state.flEditData.Banner1 = 0;
                          this.state.flEditData.Banner2 = 0;
                          this.state.flEditData.B1 = 0;
                          this.state.flEditData.B2 = 0;
                          this.state.provider = 0;
                          this.state.flEditData.VideoMicrosite = false;
                        }
            ...
            <div className="SchedHouseAdwrp">
              ...
              <div className="SchedEdtFileTopWrp">
                ...
                >
                  ...
                  {this.state.typeL === 3 ||
                    (this.state.typeL === "3" && (
                      <div className="SchedDisbleWrp c3" disabled={true}></div>
                    ))}
                </div>
                <div
                  className="SchedEdtFileTopChild1"
        ...
        {!this.state.group ? (
          <div className={"SchedGrpFilVWrp"}>
            <div
              className={
                this.state.grpFileView ? "mxTableBorder" : "mxTableBorder1"
              }
            >
              {this.state.columnSt && (
                <ColumnStatus
              ...
              <ReactTable
                ...
                style={{
                  height: this.state.schedBtm ? "280px" : "400px", //
                }}
                getTheadFilterProps={(state, rowInfo, column, instance) => {
                  return {
                    style: { display: "none" },
                  ...
                  {this.state.tabIndex === 0 ? (
                    <div style={{ display: "flex" }}>
                      <img
                        ...
                        className="grShedImg"
                        onClick={() => this.setState({ schedVideo: true })}
                      ></img>
                      <img
                      ...
                      return {
                        ...
                        onDoubleClick: () => {
                          ...
                          if (rowInfo.original.TIMESTART) {
                            console.log(
                              "sadjhaskjdahksdja",
                              rowInfo.original.TIMESTART
                            );
                            timeSrthr = rowInfo.original.TIMESTART.substring(
                              0,
                              2
                            );
                            timeSrtmin = rowInfo.original.TIMESTART.substring(
                              2,
                              5
                            );
                            console.log(timeSrthr, timeSrtmin);
                            if (timeSrthr.charAt(0) === "0") {
                              timeSrthr = rowInfo.original.TIMESTART.substring(
                                1,
                                2
                              );
                            }
                            if (timeSrtmin.charAt(0) === "0") {
                              timeSrtmin = timeSrtmin.substring(1, 2);
                            }
                            console.log(timeSrthr, timeSrtmin);
                          } else {
                            if (rowInfo.original.TimeStart) {
                              ...
                              if (timeSrthr.charAt(0) === "0") {
                                timeSrthr =
                                  rowInfo.original.TimeStart.substring(1, 2);
                              }
                              if (timeSrtmin.charAt(0) === "0") {
                                timeSrtmin = timeSrtmin.substring(1, 2);
                              }
                          ...
                          if (rowInfo.original.TIMEEND) {
                            timeEndhr = rowInfo.original.TIMEEND.substring(
                              0,
                              2
                            );
                            timeEndmin = rowInfo.original.TIMEEND.substring(
                              2,
                              5
                            );
                            if (timeEndhr.charAt(0) === "0") {
                              timeEndhr = rowInfo.original.TIMEEND.substring(
                                1,
                                2
                              );
                            }
                            if (timeEndmin.charAt(0) === "0") {
                              timeEndmin = timeEndmin.substring(1, 2);
                            }
                          } else {
                            if (rowInfo.original.TimeEnd) {
                              timeEndhr = rowInfo.original.TimeEnd.substring(
