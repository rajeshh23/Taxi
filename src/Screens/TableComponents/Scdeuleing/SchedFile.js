...
const subTabs = [
  ...
  "Associated Groups",
  "Associated GeoZones",
  "Associated Rate Codes",
  "Associated Pick-Up GeoZones",
];
const subTabsKey = [
  "FileDetails",
  "FileGroups",
...
const tabsUrl = [
  "GroupAds_Flash_Video/GetAllVideosForGroup/",
  "GroupAds_Flash_Banner_Group/GetAllBannersForGroup/",
];
...
export default class TableGrid extends Component {
  ...
  rateCodesCol = [
    {
      ...
      Cell: (rowInfo) => (
        <ComCheck
          ...
          checked={this.state.rateCodesDt.indexOf(rowInfo.original.ID) >= 0}
        ...
        <div className="ScheduleHeaderWrp">
          ...
          {this.state.grpfilterVal[1] === "" ? (
            <img
              ...
              onClick={() => this.grpsetFilter(cellInfo.column.id, 1)}
            ></img>
          ) : (
            <img
      ...
      Filter: (cellInfo) => (
        <div>
          {this.state.grpvisibleFilters.indexOf(cellInfo.column.id) >= 0 && (
            <Search
              onChange={(e) =>
                this.grpcustomFilerChange(e.target.value, cellInfo.column.id, 1)
              }
              value={this.state.grpfilterVal[1]}
            ></Search>
          )}
        </div>
      ),
        ...
        <div className="ScheduleHeaderWrp">
          ...
          {this.state.grpfilterVal[2] === "" ? (
            <img
              src={require("../../../Assets/Images/Filter/filter.png")}
              className="ScheduleheadFilt"
              onClick={() => this.grpsetFilter(cellInfo.column.id, 2)}
            ></img>
          ) : (
            <img
              src={require("../../../Assets/Images/Filter/filter_active.png")}
        ...
        <div>
          {this.state.grpvisibleFilters.indexOf(cellInfo.column.id) >= 0 && (
            <Search
              ...
              value={this.state.grpfilterVal[2]}
            ></Search>
          )}
        </div>
      ),
  ...
  setSwicthCol(colData, type) {
    ...
    colData.map((key, index) => {
      ...
      if (key.accessor === "FileType") {
        ...
        obj = {
          ...
          //   </div>,
          Cell: (rowInfo) => (
            <span>{dataChannel[rowInfo.original.Channel]}</span>
          ),
        };
        ...
        obj = {
          ...
          //       </div>,
          Cell: (rowInfo) => (
            <span>{loopType[rowInfo.original.IndexType]}</span>
          ),
        };
        ...
        obj = {
          ...
          //     </div>,
          Cell: (rowInfo) => (
            <span>{FScreen[rowInfo.original.FULLSCR_NG]}</span>
          ),
        };
        ...
        obj = {
          ...
          filterMethod: (filter, row, rowInfo) => {
            ...
            if (row[filter.id]) {
              ...
              rowInfo.original.FileDetails.map((key, index) => {
                if (
                  String(
                    key.Group_ADS_NAME.toUpperCase().indexOf(
          ...
          Cell: (rowInfo) => (
            <div>
              {rowInfo.original.FileDetails &&
                rowInfo.original.FileDetails.length > 0 && (
                  <div>
                    {rowInfo.original.FileDetails.map((key, index) => {
        ...
        key.accessor === "VBannerName" ||
        key.accessor === "HBannerName" ||
        key.accessor === "VFileDisplayName" ||
        key.accessor === "HFileDisplayName"
      ) {
        obj = {
          Header: (cellInfo) => (
            <div>
          ...
          Cell: (rowInfo) => (
            <div className="SystFlColContainer">
              <span className="SystFlColTxt">
                {rowInfo.original[key.accessor]}
              </span>
              {key.accessor === "VBannerName" ||
              key.accessor === "HBannerName" ||
              key.accessor === "VFileDisplayName" ||
              key.accessor === "HFileDisplayName" ? (
                <img
                  onMouseMove={() =>
                    this.showImgToolTip(
                      key.accessor === "VBannerName" ||
                        key.accessor === "VFileDisplayName"
                        ? rowInfo.original.WebVisibleURLVBanner
                        : rowInfo.original.WebVisibleURLHBanner
                    )
                  }
                  onMouseLeave={() => this.hideImgToolTip("")}
                  src={
                    rowInfo.original[key.accessor]
                      ? require("../../../Assets/Images/Media/image-preview.png")
                      : ""
                  }
                ...
                <img
                  ...
                  onClick={() =>
                    this.showPreview(rowInfo.original.WebVisibleURL)
                  }
                  className="MediaFlColDnldImg"
                ></img>
              ) : (
        ...
        obj = {
          ...
          Cell: (rowInfo) => (
            <div className="SystFlColContainer geoZoneCell">
              {rowInfo.original.FileGeoZones &&
                rowInfo.original.FileGeoZones.length > 0 && (
                  <img
                    src={require("../../../Assets/Images/Schedule/geoZone.PNG")}
                    className="MediaFlColDnldImg"
                  ></img>
                )}
            </div>
        ...
        key.accessor === "DATESTART" ||
        key.accessor === "DATEEND" ||
        key.accessor === "DateStart" ||
        key.accessor === "DateEnd"
      ) {
        obj = {
    ...
    if (type === "nonGroup") {
          ...
          <div style={{ paddingBottom: "10px" }}>
            {rowInfo.original.ColorStatus !== 3 && (
              <img
                src={require("../../../Assets/Images/Group/delete-over.png")}
                className="SchedGrpTableToolImg1"
                onClick={() => this.deleteSchedFile(rowInfo.original)}
              ></img>
            )}
          </div>
        ), // Custom cell components!
      ...
      dColumn.push(obj);
      this.setState({ columns: dColumn, loading: false }, () =>
      ...
      let obj = {
        Header: "#",
        Cell: (rowInfo) => (
          <div className="SchedCheck">
            <ComCheck
              onChange={(e) => this.setDelete(rowInfo.index)}
              containerStyle={"ComCheckMainWrp"}
              tickStyle={"SchedCheckTick"}
              checked={false}
            ></ComCheck>
      ...
      this.setState(
        { switchcolumns: dColumn, group: true, loading: false },
        () => this.getRecords("GroupADSFLFiles/Fetch")
      );
    }
  }
    ...
    if (previewCol) {
      ...
      previewCol.map((key, index) => {
        ...
        if (key.accessor === "IndexType") {
          ...
          key.accessor === "DATESTART" ||
          key.accessor === "DATEEND" ||
          key.accessor === "strDATEEND" ||
          key.accessor === "strDATESTART"
        ) {
          obj = {
            Header: (cellInfo) => (
              <div className="ScheduleHeaderWrp">
  ...
  setChnlFilter(e, key, accessor, index1, type, type1) {
    ...
    for (let i = 0; i < type1.length; i++) {
      if (
        e.target.value !== "" &&
        type1[i].toUpperCase().includes(e.target.value.toUpperCase())
      ) {
        if (index === -1) {
          index = i;
        }
  ...
  getRecords(url) {
    ...
    if (this.state.group === true) {
      ...
      if (this.state.grpData && this.state.grpData.length === 0) {
        ...
        getData(tabsUrl[this.state.tabIndex] + this.state.grpId).then((res) => {
      ...
      postData(url, obj).then((res) => {
        if (res && res.data && res.data.ResponseCollection) {
          this.setState(
            { data: res.data.ResponseCollection[0], flLoading: false },
            () => {
              if (this.state.grpData && this.state.grpData.length === 0) {
                this.getGrpData("GroupADSFL/Fetch");
              }
  ...
  getGeoZoneData() {
    getData("Geozone/GetAllGeoZones/0").then((res) => {
  ...
  getRateCodeData() {
    getData("Geozone/fetchRateCodes").then((res) => {
      if (res && res.data && res.data.ResponseCollection) {
  ...
  getHouseData() {
    getData("HouseAdvDetails/GetHouseAdDetail").then((res) => {
      if (res && res.data && res.data.ResponseCollection) {
  ...
  deleteSchedFile(data) {
    ...
    postData("GroupADSFLFiles/Update", obj).then((res) => {
  ...
  getPreviewData() {
    if (this.state.SelectedGroupIds && this.state.SelectedGroupIds.length > 0) {
      ...
      getData("PreviewLoop/FetchPreviewLoop/" + Str).then((res) => {
        if (res.data.ResponseCollection) {
          console.log(res.data.ResponseCollection);
          this.setState({
            prevData: res.data.ResponseCollection,
            previewLoop: true,
          });
        } else {
  ...
  setGroupInf(rowInfo) {
    if (rowInfo) {
      this.setState({
        groupName: rowInfo.original["Group_ADS_Name"],
        grpIndex: rowInfo.index,
      });
      ...
      subTCol[index].map((key, index) => {
        ...
        if (
          ...
          obj = {
              ...
              <div className="ScheduleHeaderWrp">
                ...
                {this.state.subTabFilterVal[index] === "" ? (
                  <img
                    ...
                    className="ScheduleheadFilt"
                    onClick={() =>
                      this.setSubTabFilter(cellInfo.column.id, index)
                    }
                  ></img>
                ) : (
                  <img
            ...
            Filter: (cellInfo) => (
              <div>
                {this.state.subTabVisibleFilters.indexOf(cellInfo.column.id) >=
                  0 && (
                  <Search
                    onChange={(e) =>
                      this.customsubTabFilerChange(
                        e.target.value,
                        cellInfo.column.id,
                        index
                      )
                    }
                    value={this.state.subTabFilterVal[index]}
                  ></Search>
                )}
              </div>
            ),
  ...
  getAvailableMicrisites() {
    ...
    postData("FileUpload/FetchFiles", obj).then((res) => {
      if (res.data && res.data.ResponseCollection) {
  ...
  setFullScreenOpt(e) {
    if (e.target.value == 1) {
      if (
        ...
        //alert('tumhich');
        var msg =
          "Full Screen option cannot be selected 'True' when banners are associated";
        this.setState({
          dlgtitle: "Information",
          message: msg,
          dlgType: "information",
  ...
  upDateHouseAd() {
    postData("HouseAdvDetails/AddHouseAdDetail", this.state.houseObj).then(
      (res) => {
        ...
        arrGroupADSL_VideoVO: [
          {
            ...
            strDATESTART: moment(this.state.dateStart).format(
              "ddd MMM DD YYYY"
            ),
  ...
  editLoadFile() {
    ...
    if (
      type === 0 &&
      this.state.flEditData.Microsite &&
      this.state.flEditData.Microsite > 0 &&
      this.state.flEditData.VideoMicrosite == false
    ) {
      if (
        this.state.flEditData.WebVisibleURLHBanner == "" ||
    ...
    if (msg === "") {
      ...
      if (
        this.state.fScreen == true ||
        this.state.fScreen == "1" ||
        this.state.fScreen == 1
      ) {
        fScreen = 1;
      }
        ...
        if (this.state.flEditData.FileType == 0) {
          obj = {
            editGROUP_ADSFL_Video: {
              ...
              ORDERLOOP: this.state.order,
              strDATESTART: moment(this.state.flEditData.DATESTART).format(
                "ddd MMM DD YYYY"
              ),
              TIMESTART: this.state.timeSrthr + ":" + this.state.timeSrtmin,
              strDATEEND: moment(this.state.flEditData.DATEEND).format(
                "ddd MMM DD YYYY"
              ),
              TIMEEND: this.state.timeEndhr + ":" + this.state.timeEndmin,
              FULLSCR_NG: fScreen,
          ...
          obj = {
            editGROUP_ADSFL_Banner: {
              ...
              EndDate: moment(this.state.flEditData.DATEEND).format(
                "ddd MMM DD YYYY"
              ),
              TimeEnd: this.state.timeEndhr + ":" + this.state.timeEndmin,
              FileId_V: this.state.flEditData.Banner1,
              FileId_H: this.state.flEditData.Banner2,
              Length: this.state.flEditData.Len
                ? this.state.flEditData.Len
                : this.state.fLength,
              SurveyID: this.state.flEditData.SurveyID,
              OrderLoop: this.state.order,
              TimeStart: this.state.timeSrthr + ":" + this.state.timeSrtmin,
              StartDate: moment(this.state.flEditData.DATESTART).format(
                "ddd MMM DD YYYY"
              ),
  ...
  setGeoZoneSelection(type) {
    ...
    if (type === "add" && this.state.geoZoneIndex.length > 0) {
      ...
      this.setState({
        geoZone1Data: data1,
        geoZone2Data: newModarray,
        geoZoneIndex: [],
        adujstRow: tempEmptyRow,
      });
    ...
    if (this.state.flEditData.FileType == 0) {
      if (this.state.FlDtTabIndex === 2) {
        ...
        if (this.state.geoZone2Data) {
          ...
          if (
            !this.state.group &&
            this.state.data[this.state.FlDtIndex].FileGroups
          ) {
            for (
              let i = 0;
              i < this.state.data[this.state.FlDtIndex].FileGroups.length;
              i++
            ) {
              let myobj = {
                Group_ADS_ID:
                  this.state.data[this.state.FlDtIndex].FileGroups[i]
                    .Group_ADS_ID,
              };
              groupIds.push(myobj);
            }
    ...
    if (this.state.rateCodesDt) {
      ...
      if (
        ...
        for (
          ...
          let obj = {
            Group_ADS_ID:
              this.state.data[this.state.FlDtIndex].FileGroups[i].Group_ADS_ID,
          };
          groupIds.push(obj);
        }
      } else {
      ...
      postData("GroupAds_Flash_Video/updateRateCode", myObj).then((res) => {
        if (res.data && res.data.ReturnCode === 0) {
          this.setState(
            {
              dlgtitle: "Information",
      ...
      if (type === 1) {
        ...
        for (let i = 0; i < this.state.deletData.length; i++) {
          let obj1 = {
            ...
            GROUP_ADSFL_DETAILID:
              this.state.data[this.state.deletData[i]].GROUP_ADSFL_DETAILID, ///deatails  row id
          };
          data.push(obj1);
        }
        obj = {
  ...
  fetchunitTypeData() {
    ...
    postData("UnitTypes/Fetch", obj).then((res) => {
      if (res && res.data && res.data.ResponseCollection) {
  ...
  fetchProviderData() {
    getData("GroupADSFLFiles/FetchProvider").then((res) => {
      if (res && res.data && res.data.ResponseCollection) {
  ...
  addGroupToDatabase = () => {
    ...
    if (msg) {
      ...
      postData("GroupADSFL/Update", obj).then((res) => {
        if (res.data && res.data.ReturnCode === 0) {
          this.setState(
            {
              grpInfo: false,
  ...
  editGroupToDatabase = () => {
    ...
    let msg = "";
    if (
      !this.state.groupEditData.Group_ADS_Name ||
      this.state.groupEditData.UnitType === undefined ||
      this.state.groupEditData.UnitType === ""
    ) {
    ...
    if (msg) {
      ...
      postData("GroupADSFL/Update", obj).then((res) => {
        if (res.data && res.data.ReturnCode === 0) {
          ...
          if (res.data && res.data.ReturnCode === 4) {
            this.setState({ grpEditInfo: false, grpObj: {} }, () =>
              this.getGrpData("GroupADSFL/Fetch", "get")
            );
            this.setState({
              dlgtitle: "Information",
  ...
  handleDeleteGrp = () => {
    if (this.state.grpDelete.length > 0) {
      ...
      for (let i = 0; i < this.state.grpDelete.length; i++) {
        let obj = {
          Group_ADS_Name:
            this.state.grpData[this.state.grpDelete[i]].Group_ADS_Name,
          Group_ADS_ID:
            this.state.grpData[this.state.grpDelete[i]].Group_ADS_ID,
        };
        arr.push(obj);
        gNamestr +=
          this.state.grpData[this.state.grpDelete[i]].Group_ADS_Name + " , ";
      ...
      postData("GroupADSFL/Update", obj).then((res) => {
        if (res.data && res.data.ReturnCode === 0) {
          this.setState({ dataLoading: true, grpDelete: [] }, () =>
            this.getGrpData("GroupADSFL/Fetch", "get")
          );
          let msg = "";
          ...
          if (
            ...
            res.data.StatusResponseCollection[0] == 4
          ) {
            console.log("check2");
            msg =
              "Unable to delete group(s)  " +
              gNamestr +
              " as some contents are scheduled in it.";
          } else {
            console.log("check3");
  ...
  updategroupStatus(value) {
    ...
    postData("GroupADSFL/ChangeGroupStatus", obj).then((res) => {
      if (res.data && res.data.ReturnCode === 0) {
        this.setState({ display: 0, grpData: [], grpDelete: [] }, () =>
          this.getGrpData("GroupADSFL/Fetch", "get")
        );
        this.setState({
          dlgtitle: "Information",
  ...
  handleStatusChangeold = (value) => {
    if (this.state.grpDelete.length > 0) {
      ...
      postData("GroupADSFL/ChangeGroupStatus", obj).then((res) => {
        if (res.data && res.data.ReturnCode === 0) {
          this.setState({ display: 0, grpDelete: [] }, () =>
            this.getGrpData("GroupADSFL/Fetch", "get")
          );
          this.setState({
            dlgtitle: "Information",
  ...
  setBtmDetails(data, flage) {
    ...
    if (data && this.state.FlDtTabIndex === 0) {
      ...
      if (
        this.state.data[this.state.FlDtIndex].FileGeoZones &&
        this.state.data[this.state.FlDtIndex].FileGeoZones.length > 0
      ) {
        this.state.geoZone2Data = this.removeDuplicates(
          this.state.data[this.state.FlDtIndex].FileGeoZones,
          "ID"
        );
      }
      ...
      if (
        this.state.data[this.state.FlDtIndex].FileGroups &&
        this.state.data[this.state.FlDtIndex].FileGroups.length > 0
      ) {
        for (
          let i = 0;
          i < this.state.data[this.state.FlDtIndex].FileGroups.length;
            ...
            for (let j = 0; j < temp.length; j++) {
              for (let x = 0; x < this.state.rateCodeList.length; x++) {
                if (temp[j] === this.state.rateCodeList[x].Name) {
                  let index = this.state.rateCodesDt.indexOf(
                    this.state.rateCodeList[x].ID
                  );
                  if (index === -1) {
      ...
      if (
        ...
        for (
          ...
          if (
            this.state.data[this.state.FlDtIndex].FileGroups[i].PickupGeozone
          ) {
            let temp =
              this.state.data[this.state.FlDtIndex].FileGroups[
                i
              ].PickupGeozone.split(/\s*,\s*/);
            for (let j = 0; j < temp.length; j++) {
              for (let x = 0; x < this.state.geoZoneData.length; x++) {
                if (temp[j] === this.state.geoZoneData[x].Name) {
                  let index = this.state.geoZone2Data.indexOf(
                    this.state.geoZoneData[x]
                  );
                  if (index === -1) {
  ...
  setContextMenu(type) {
    if (type === "Geozone") {
      if (
        ...
        this.state.geoZone2Data =
          this.state.data[this.state.FlDtIndex].FileGeoZones;
      }
      this.setState({
        btmGeoZoneAssociation: true,
        rightAction: 0,
        FlDtTabIndex: 2,
      });
      ...
      if (this.state.data[this.state.FlDtIndex].RateCode) {
        let temp =
          this.state.data[this.state.FlDtIndex].RateCode.split(/\s*,\s*/);
        for (let j = 0; j < temp.length; j++) {
          for (let x = 0; x < this.state.rateCodeList.length; x++) {
            if (temp[j] === this.state.rateCodeList[x].Name) {
              let index = this.state.rateCodesDt.indexOf(
      ...
      if (this.state.data[this.state.FlDtIndex].PickupGeozone) {
        let temp =
          this.state.data[this.state.FlDtIndex].PickupGeozone.split(/\s*,\s*/);
        for (let j = 0; j < temp.length; j++) {
          for (let x = 0; x < this.state.geoZoneData.length; x++) {
            if (temp[j] === this.state.geoZoneData[x].Name) {
              let index = this.state.geoZone2Data.indexOf(
  ...
  copyVideo(type) {
    if (this.state.deletData.length > 0 && this.state.grpDelete.length > 0) {
      ...
      postData("GroupAds_Flash_Video/AddAllVideosToGroups", myobj).then(
        (res) => {
          if (res.data.ReturnCode === 0) {
            this.setState(
              {
      ...
      <div>
        {this.state.loading ? (
          ...
          <div className="Loader">
            <div className="SchedBnrWrp" draggable={true}>
              ...
              <div className="SchedEdtFileTopWrp">
                  ...
                  {this.addobj && this.addobj.WebVisibleURLVBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                          src={this.addobj.WebVisibleURLVBanner}
                          className="SchedBnrpopImg_V"
                        ></img>
                        <div className="SchedBnrpopImgOvrWrp">
                          <img
                            src={require("../../../Assets/Images/Group/delete-over.png")}
                            className="SchedGrpTableToolImg3"
                            onClick={(e) => {
                              e.stopPropagation();
                ...
                >
                  <span className="SchedBnrPopImgTypetxt">
                    Horizontal Banner
                  </span>
                  {this.addobj && this.addobj.WebVisibleURLHBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                          src={this.addobj.WebVisibleURLHBanner}
                          className="SchedBnrpopImg_H"
                        ></img>
                        <div className="SchedBnrpopImgOvrWrp">
                          <img
                            src={require("../../../Assets/Images/Group/delete-over.png")}
              ...
              <div className="SchedBnrPopImgWrp2" style={{ marginTop: "13px" }}>
                ...
                <div className="RightDiv-md2">
                  <input
                    className="SchedBnrPopinpt2"
                    type="number"
                    min="0"
                    max="23"
                    value={this.state.timeSrthr}
                    onChange={(e) =>
                      this.setState({ timeSrthr: e.target.value })
                    }
                  ></input>
                  <input
                    className="SchedBnrPopinpt2"
                    ...
                    onChange={(e) =>
                      this.setState({ timeSrtmin: e.target.value })
                    }
                  ></input>
                </div>
                <div className="leftDiv-md2">
                  <span className="SchedBnrPopTxt" style={{ marginLeft: "2%" }}>
                    Time End *
                  </span>
                </div>
                <div className="RightDiv-md2">
                  <input
                    ...
                    onChange={(e) =>
                      this.setState({ timeEndhr: e.target.value })
                    }
                  ></input>
                  <input
                    className="SchedBnrPopinpt2"
                    ...
                    onChange={(e) =>
                      this.setState({ timeEndmin: e.target.value })
                    }
                  ></input>
                </div>
              </div>
                ...
                <div className="RightDiv-md2">
                  ...
                  >
                    ...
                    {this.state.micrositeList.map((key, index) => {
                      return <option value={key.FileID}>{key.TempName}</option>;
                    })}
                  </select>
                </div>
                <div className="leftDiv-md2"></div>
              ...
              <div className="SchedBnrPopImgWrp2">
                ...
                <div className="RightDiv-md2">
                  <input
                    style={{ width: "59%", "margin-left": "4px" }}
                    min="1"
                    max="65535"
                    className="SchedBnrPopinpt"
                    type="number"
                  ...
                  <div className="SchedBnrInptWrp">
                    ...
                    >
                      ...
                      {this.state.userList.map((key, index) => {
                        return <option value={key.userId}>{key.Name}</option>;
                      })}
                    </select>
                    <span
                      className="SchedBnrPopTxt"
            ...
            <div className="SchedBnrWrp1" draggable={true}>
              ...
              <div className="SchedEdtFileTopWrp1">
                  ...
                  {this.addobj && this.addobj.WebVisibleURL ? (
                    ...
                    <div>
                      <img
                        ...
                        className="SchedBnrpopImg"
                      ></img>
                      <span className="SchedBnrPopImgTypetxt2">
                        {this.addobj.FileName
                          ? this.addobj.FileName
                          : "No image"}
                      </span>
                ...
                >
                  ...
                  {this.state.typeL === 3 ||
                  this.state.typeL === "3" ||
                  this.state.VideoMicrosite == true ? (
                    <div
                      onClick={(e) => e.stopPropagation()}
                      className="SchedDisbleWrp"
                      disabled={true}
                    ></div>
                  ) : (
                    <div></div>
              ...
              <div className="SchedBnrInptWrp">
                <div className="leftDiv-md2">
                  <span className="SchedBnrPopTxt" style={{ marginLeft: "4%" }}>
                    Channel *
                  </span>
                </div>
                <div className="RightDiv-md2">
              ...
              <div className="SchedBnrInptWrp">
                <div className="leftDiv-md2">
                  <span
                    className="SchedBnrPopTxt"
                    style={{ marginLeft: "-1.5%", marginTop: "10px" }}
                  >
                    Full Screen *
                  </span>
                </div>
                <div className="RightDiv-md2">
                  <select
                    style={{ width: "43%" }}
                    className="SchedDropDwn1"
                    onChange={(e) => this.setFullScreenOpt(e)}
              ...
              <div className="SchedBnrInptWrp">
                ...
                <div
                  style={{ paddingLeft: "22px", marginTop: "6px" }}
                  className="RightDiv-md2"
                >
                  {this.state.typeL == 0 ? (
                    <div>
                      <input
                        ...
                        name="allEmployeesCheckBox"
                        className="styled pending-assign-user"
                        checked={this.state.VideoMicrosite}
                        onChange={(e) => {
                          this.checkAutoDispaly(e);
                        }}
                      ></input>
                      <span
                        className="SchedBnrPopTxt"
              ...
              <div className="SchedBnrInptWrp">
                <div className="leftDiv-md2">
                  <span className="SchedBnrPopTxt" style={{ marginLeft: "5%" }}>
                    Length *
                  </span>
                </div>
                <div className="RightDiv-md2">
              ...
              <div className="SchedPopBtnWrp">
                {this.state.group ? (
                  <img
                    ...
                    className={
                      !this.state.isenableschedBtn
                        ? "ForgPassBtn disabledBtn"
                        : "ForgPassBtn"
                    }
                    disabled={!this.state.isenableschedBtn}
                    onClick={() => this.schedValid(0)}
                  ></img>
                ) : (
                  <img
                    style={{ paddingRight: "10px", cursor: "pointer" }}
          ...
          <div className="Loader">
            <div className="SchedBnrWrp1">
              <div className="ForgPassTitle ShedTitle">
                <div style={{ width: "96%" }}>Media Scheduling</div>
                <div className="ShedHide" onClick={() => this.resetEditState()}>
                  X
                </div>
              </div>
              <div className="SchedEdtFileTopWrp">
                {this.state.flEditData.FileType === 0 && (
                  <div
                    className="SchedEdtFileTopChild"
                    onClick={() => this.loadFiles(1, "video")}
                  >
                    <span className="SchedBnrPopImgTypetxt">File</span>
                    {this.state.flEditData &&
                    this.state.flEditData.WebVisibleURL ? (
                      <div>
                        <div className="SchedBnrpopImgWrp">
                          <img
                            src={this.getThumnail(
                              this.state.flEditData.WebVisibleURL
                            )}
                            className="SchedBnrpopImg"
                          ></img>
                ...
                <div
                  className="SchedEdtFileTopChild"
                  onClick={() => this.loadFiles(3, "Vbanner")}
                >
                  <span className="SchedBnrPopImgTypetxt">Vertical Banner</span>
                  {this.state.flEditData &&
                  this.state.flEditData.WebVisibleURLVBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                          src={this.state.flEditData.WebVisibleURLVBanner}
                          className="SchedBnrpopImg_V"
                        ></img>
                        <div className="SchedBnrpopImgOvrWrp">
                          <img
                  ...
                  {this.state.typeL == 3 ||
                  this.state.typeL == "3" ||
                  this.state.flEditData.VideoMicrosite ? (
                    <div
                      onClick={(e) => e.stopPropagation()}
                      className="SchedDisbleWrp"
                    ></div>
                ...
                <div
                  className="SchedEdtFileTopChild"
                  onClick={() => this.loadFiles(2, "Hbanner")}
                >
                  <span className="SchedBnrPopImgTypetxt">
                    Horizontal Banner
                  </span>
                  ...
                  this.state.flEditData.WebVisibleURLHBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                          src={this.state.flEditData.WebVisibleURLHBanner}
                          className="SchedBnrpopImg_H"
                        ></img>
                        <div className="SchedBnrpopImgOvrWrp">
                          <img
              ...
              <div className="SchedBnrInptWrp">
                <div className="leftDiv-md2">
                  <span className="SchedBnrPopTxt" style={{ marginLeft: "3%" }}>
                    Channel *
                  </span>
                </div>
                <div className="RightDiv-md2">
                  ...
                  <div className="RightDiv-md2">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        this.state.flEditData.ORDERLOOP = e.target.value;
                      }}
                    ></input>
                  </div>
                  <div className="leftDiv-md2"></div>
              ...
              {this.state.editGrFile && (
                <div className="SchedBnrInptWrp">
                  ...
                  <div className="RightDiv-md2">
                    <DatePicker
                      selected={this.state.flEditData.DATESTART}
                      onChange={(date) => {
                        this.setState({ dateStart: date });
                        this.state.flEditData.DATESTART = date;
                      }}
                      wrapperClassName=""
                      className="SchedDatePickInptWrp"
                      popperPlacement="right-start"
                  ...
                  <div className="RightDiv-md2">
                    <DatePicker
                      selected={this.state.flEditData.DATEEND}
                      onChange={(date) => {
                        this.setState({ dateEnd: date });
                        this.state.flEditData.DATEEND = date;
                      }}
                      wrapperClassName=""
                      className="SchedDatePickInptWrp"
                      popperPlacement="right-start"
              ...
              <div className="SchedBnrInptWrp">
                ...
                <div className="RightDiv-md2" style={{ marginLeft: "-5px" }}>
                  <select
                    ...
                    className="SchedDropDwn1"
                    onChange={(e) => {
                      this.setState({ mSite: e.target.value });
                      this.state.flEditData.Microsite = e.target.value;
                    }}
                    value={
                      this.state.flEditData.Microsite
                        ? this.state.flEditData.Microsite
                      ...
                      {this.state.typeL == 0 ? (
                        <div>
                          <input
                            ...
                            name="allEmployeesCheckBox"
                            className="styled pending-assign-user"
                            checked={this.state.flEditData.VideoMicrosite}
                            onChange={(e) => {
                              this.checkAutoDispaly(e);
                            }}
                          ></input>
              ...
              <div className="SchedBnrInptWrp">
                ...
                <div className="RightDiv-md2">
                  <input
                    ...
                    className="SchedBnrPopinpt"
                    disabled={
                      this.state.flEditData.FileType === 0 ? true : false
                    }
                    type="number"
                    onChange={(e) => this.setState({ fLength: e.target.value })}
                    value={this.state.flEditData.Len}
                    min="0"
                  ></input>
                </div>
                <div className="leftDiv-md2"></div>
              ...
              <div
                className={
                  this.state.editGrFile
                    ? "SchedEditBtnWrp videoEditMargin"
                    : "SchedEditBtnWrp"
                }
              >
                <img
            ...
            {this.state.schedEdit && (
              <Dialog
                title={this.state.dlgtitle}
                message={this.state.message}
                onOk={() => this.setState({ schedEdit: false })}
                onHide={() => this.setState({ schedEdit: false })}
              />
            )}
          </div>
        ) : this.state.upload ? (
          ...
          <div className="Loader">
            <div className="SchedBnrWrp4">
              ...
              <div className="shedSelGrSubTitle">Select Groups</div>
              <div className="SchedgrpSelWrp">
                <ReactTable
                  columns={grpCol1}
                  data={this.state.grp1Data}
                  pageSize={
                    this.state.grp1Data.length ? this.state.grp1Data.length : 20
                  }
                  showPagination={false}
                  sortable={false}
                  NoDataComponent={() => null}
                  getTrGroupProps={(state, rowInfo, column, instance) => {
                    if (rowInfo !== undefined) {
                      return {
                        ...
                        style: {
                          background:
                            this.state.grp1Index.indexOf(rowInfo.index) >= 0
                              ? "#5ca0f2"
                              : "",
                        },
                      };
                ...
                <div className="SchedgrpSelBtnWrp">
                  ...
                  <div
                    className="SchedSleGrpbtn"
                    onClick={() => this.setGroupSelection("remove")}
                  >
                    {"<"}
                  </div>
                </div>
                        ...
                        <div>
                          {this.state.grp2Data.map((key, index) => {
                            return (
                              <div
                                className={
                                  this.state.grpSelecteIndex == index
                                    ? "rt-tr-group rowgroupSelected"
                                    : "rt-tr-group"
                                }
                                onClick={() => {
              ...
              <div className="MediaFlUpldBtm">
                <img
                  ...
                  className={
                    !this.state.isenableschedBtn
                      ? "ShedGrnextBtn disabledBtn"
                      : "ShedGrnextBtn"
                  }
                  disabled={!this.state.isenableschedBtn}
                  onClick={() => this.backtoShedul()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/ok-btn.png")}
                  className="ShedGrnextBtn"
                  onClick={() => this.checkSelectedGroupLength()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/cancel-btn.png")}
                  className="ShedGrnextBtn"
          ...
          <div className="Loader">
            <div className="SystemAddRelWrp">
              ...
              >
                ...
                <input
                  className="grpName innershadow"
                  value={this.state.grpObj.groupName}
                  onChange={(e) =>
                    this.handleValues(e.target.value, "groupName")
                  }
                ></input>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <DatePicker
                    selected={this.state.grpObj.startDate}
                ...
                >
                  ...
                  <DatePicker
                    selected={this.state.grpObj.endDate}
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      this.handleValues(e.target.value, "unitType")
                    }
                  >
            ...
            <div className="SystemAddRelWrp">
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.handleEditValues(e.target.value, "Group_ADS_Name")
                  }
                ></input>
              </div>
              <div>
                ...
                >
                  ...
                  <DatePicker
                    ...
                    onChange={(date) =>
                      this.handleEditValues(date, "StartDate")
                    }
                    wrapperClassName="grpDatePickWrp"
                    className="DatePickInptWrp"
                    popperPlacement="right-start"
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      this.handleEditValues(e.target.value, "UnitType")
                    }
                  >
                    <option value="">Select Unit Type</option>
                    {this.state.unitData.map((key, index) => {
              ...
              <div className="SystFlUpldBtm">
                <img
                  src={require("../../../Assets/Images/Login/ok-btn.png")}
                  className="SystFlnextBtn"
                  onClick={() => this.editGroupToDatabase()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/cancel-btn.png")}
                  className="SystFlnextBtn"
          ...
          <div className="Loader">
            <div className="SchedBtmDtPopWrp">
              ...
              <div className="SchedBnrPopImgWrp2" style={{ marginTop: "10px" }}>
                ...
                <div className="leftDiv-md2">
                  <span className="SchedBnrPopTxt" style={{ marginLeft: "6%" }}>
                    Date End *
                  </span>
                </div>
                <div className="RightDiv-md2">
            ...
            <div className="SchedBnrWrp4">
              ...
              <div className="MediaFlUpldBtm">
                <img
                  src={require("../../../Assets/Images/Login/ok-btn.png")}
                  className="SystFlnextBtn"
                  onClick={() => this.associateGroupsTofile()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/cancel-btn.png")}
                  className="SystFlnextBtn"
            ...
            <div className="SchedBnrWrp4">
              ...
              <div className="SchedgrpSelWrp">
                <ReactTable
                  ...
                  defaultPageSize={20}
                  pageSize={
                    this.state.geoZone1Data.length
                      ? this.state.geoZone1Data.length
                      : 20
                  }
                  showPagination={false}
                  ...
                  getTrGroupProps={(state, rowInfo, column, instance) => {
                    if (rowInfo !== undefined) {
                      return {
                        ...
                        style: {
                          background:
                            this.state.geoZoneIndex.indexOf(rowInfo.index) >= 0
                              ? "#5ca0f2"
                              : "",
                        },
                      };
                ...
                <div className="SchedgrpSelBtnWrp">
                  ...
                  <div
                    className="SchedSleGrpbtn"
                    onClick={() => this.setGeoZoneSelection("remove")}
                  >
                    {"<"}
                  </div>
                </div>
                ...
                >
                  <div className="rt-table" role="grid">
                    ...
                    <div className="rt-tbody" style={{ "min-width": "100px;" }}>
                      {this.state.geoZone2Data &&
                      this.state.geoZone2Data.length > 0 ? (
                        <div>
                          {this.state.geoZone2Data.map((key, index) => {
                            return (
                              <div
                                className={
                                  this.state.setGeoZoneIndex == index
                                    ? "rt-tr-group rowgroupSelected"
                                    : "rt-tr-group"
                                }
                                onClick={() => {
              ...
              <div className="MediaFlUpldBtm">
                <img
                  src={require("../../../Assets/Images/Login/ok-btn.png")}
                  className="SystFlnextBtn"
                  onClick={() => this.associateGeoZoneTofile()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/cancel-btn.png")}
                  className="SystFlnextBtn"
          ...
          <div className="Loader">
            <div className="SchedBnrWrp5">
              ...
              <ReactTable
                ...
                pageSize={
                  this.state.rateCodeList.length
                    ? this.state.rateCodeList.length
                    : 20
                }
                showPagination={false}
              ...
              <div className="MediaFlUpldBtm1">
                <img
                  ...
                  onClick={() => this.associatedRateCodestoFile()}
                ></img>
                <img
                  src={require("../../../Assets/Images/Login/cancel-btn.png")}
                  className="SystFlnextBtn1"
            ...
            <div className="SchedHouseAdwrp">
              <div className="ForgPassTitle ShedTitle">
                ...
                <div
                  className="ShedHide"
                  onClick={() =>
                    this.setState({ houseAd: false }, () => this.getHouseData())
                  }
                >
                  X
                </div>
              ...
              <div className="SchedEdtFileTopWrp">
                ...
                >
                  <span className="SchedBnrPopImgTypetxt">Vertical Banner</span>
                  {this.state.houseObj &&
                  this.state.houseObj.WebVisibleURLVBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                      ...
                      <span className="SchedBnrPopImgTypetxt1">
                        {this.state.houseObj.VBannerName}
                      </span>
                    </div>
                  ) : (
                    <div>
                ...
                >
                  ...
                  {this.state.houseObj &&
                  this.state.houseObj.WebVisibleURLHBanner ? (
                    <div>
                      <div className="SchedBnrpopImgWrp">
                        <img
                      ...
                      <span className="SchedBnrPopImgTypetxt1">
                        {this.state.houseObj.HBannerName}
                      </span>
                    </div>
                  ) : (
                    <div>
              ...
              <div className="SchedPrevLoopWrp">
                <div className="ForgPassTitle">
                  ...
                  <img
                    ...
                    className="SchedColStClose"
                    style={{ marginLeft: "82%" }}
                    onClick={() => this.setState({ previewLoop: false })}
                  ></img>
                </div>
                <div className="ScheduleTabToolWrp">
                  <div className="ScheduleTableToolCont">
                    ...
                    <img
                      ...
                      className="ScheduleToolImg"
                      onClick={() => this.getRecords("GroupADSFLFiles/Fetch")}
                    ></img>
                  </div>
                </div>
                <ReactTable
        ...
        {!this.state.group ? (
          <div className={"SchedGrpFilVWrp"}>
            <div
              className={
                this.state.grpFileView ? "TableBorder" : "TableBorder1"
              }
            >
              {this.state.columnSt && (
                <ColumnStatus
              ...
              <div className="ScheduleTabToolWrp">
                ...
                <div>
                  <img
                    src={require("../../../Assets/Images/Upload/schedule-btn.png")}
                    className="ScheduleupldImg1"
                    onClick={() =>
                      this.setState({
                        schedFile: !this.state.schedFile,
                        isenableschedBtn: true,
                      })
                    }
                  ></img>
                  ...
                  <div
                    className={
                      this.state.schedFile ? "Schedd_nav" : "Schedd_nav1"
                    }
                  >
                    <div
                      className="Schednav__submenu-item"
                      onClick={() =>
                        this.setState({ schedFile: false, schedVideo: true })
                      }
                    >
                      Video
                    </div>
                    <div
                      className="Schednav__submenu-item"
                      onClick={() =>
                        this.setState({ schedFile: false, schedBanner: true })
                      }
                    >
                      Banner
                    </div>
                ...
                <div className="ScheduleTableToolCont">
                  <img
                    src={require("../../../Assets/Images/tools/change-perspective.png")}
                    className="ScheduleToolImg"
                    ...
                    return {
                      onClick: (e, handleOriginal) => {
                        this.setState({ FlDtIndex: rowInfo.index }, () =>
                          console.log("MainData", rowInfo.original)
                        );
                      },
                      onDoubleClick: () => {
                        ...
                        this.state.flEditData.IndexType =
                          rowInfo.original.IndexType;
                      },
                      style: {
                        background:
                          this.state.FlDtIndex === rowInfo.index
                            ? "#5ca0f2"
              ...
              />
              <div
                className="SchedFilVwbtmTogWrp"
                onClick={() => this.setFlDetails(0, true, true)}
              >
                <img
                  src={require("../../../Assets/Images/Media/right-arrow.png")}
                  className={
                    this.state.schedBtm
                      ? "SchedBtmArrowImg2"
                      : "SchedBtmArrowImg"
              ...
              {this.state.schedBtm && (
                <div>
                  <div className="CabDtTabMainWrp">
                    {subTabs &&
                      subTabs.map((key, index) => (
                        <div
                          className={
                            this.state.FlDtTabIndex === index
                              ? "CabDtTabWrp1"
                              : "CabDtTabWrp"
                          }
                          onClick={() => this.setFlDetails(index, true, false)}
                        >
                          {key}
                        </div>
                      ))}
                  ...
                  <ReactTable
                    data={
                      this.state.data[this.state.FlDtIndex][
                        subTabsKey[this.state.FlDtTabIndex]
                      ]
                        ? this.state.data[this.state.FlDtIndex][
                            subTabsKey[this.state.FlDtTabIndex]
                          ]
            ...
            {this.state.grpFileView ? (
              <div className="SchedGrpWrp">
                <div className="SchedGrpTableToolWrp">
                  ...
                  <img
                    src={require("../../../Assets/Images/Group/delete-over.png")}
                    className="SchedGrpTableToolImg"
                    onClick={() => this.handeldeleteBeforedelete()}
                  ></img>
                  <img
                    src={require("../../../Assets/Images/separator.png")}
                    className="SchedTopCredSeprtr"
                  ...
                  <div>
                    <img
                      src={require("../../../Assets/Images/Group/change-status.png")}
                      className="SchedGrpTableToolImg"
                      onClick={() => this.openStatusDll()}
                    ></img>
                    <div
                      className={
                        this.state.showStatus ? "grpStatus" : "grpStatus_none"
                      }
                    >
                      <div
                      ...
                      <div
                        className="nav__submenu-item"
                        onClick={() => this.handleStatusChange(3)}
                      >
                        Test
                      </div>
                    </div>
                  ...
                  ></img>
                  <img
                    src={require("../../../Assets/Images/Group/house_icon_20px.gif")}
                    className="SchedGrpTableToolImg"
                    onClick={() => this.setState({ houseAd: true })}
                  ></img>
                  <img
                    src={require("../../../Assets/Images/separator.png")}
                    className="SchedTopCredSeprtr"
                  ></img>
                  <img
                    src={require("../../../Assets/Images/Group/preview.gif")}
                    className="SchedGrpTableToolImg"
                    onClick={() => this.setPrevColumns()}
                  ></img>
                  <img
                    src={require("../../../Assets/Images/separator.png")}
                    className="SchedTopCredSeprtr"
                  ...
                  <img
                    src={require("../../../Assets/Images/tools/refresh.png")}
                    className="SchedGrpTableToolImg"
                    onClick={() => this.getGrpData("GroupADSFL/Fetch", "get")}
                  ></img>
                  <img
                    src={require("../../../Assets/Images/Media/collapse-view.png")}
                    className="SchedGrpTableToolImg2"
                    onClick={() => {
                      this.setState({ grpFileView: false });
                      this.getGrpData("GroupADSFL/Fetch", "get");
                    }}
                  ></img>
                </div>
                  ...
                  getTrGroupProps={(state, rowInfo, column, instance) => {
                    if (rowInfo !== undefined) {
                      return {
                        ...
                        style: {
                          background:
                            this.state.grpId === rowInfo.original.Group_ADS_ID
                              ? "#5ca0f2"
                              : "",
                        },
                      };
                ...
                <div className="ScedGrpInfoMainWrp">
                  ...
                  <div className="SchedGrpInfoChild1">
                    <div className="SchedGrpInfoChild2">
                      Videos:
                      {this.state.grpData.length &&
                      this.state.grpData[this.state.grpIndex]
                        ? this.state.grpData[this.state.grpIndex].VideoCount
                        : 0}
                    </div>
                    <div className="SchedGrpInfoChild2">
                      Buttons:
                      {this.state.grpData.length &&
                      this.state.grpData[this.state.grpIndex]
                        ? this.state.grpData[this.state.grpIndex].ButtonCount
                        : 0}
                    </div>
                    <div className="SchedGrpInfoChild2">
                      Banners:
                      {this.state.grpData.length &&
                      this.state.grpData[this.state.grpIndex]
                        ? this.state.grpData[this.state.grpIndex].BannerCount
                        : 0}
                    </div>
                  </div>
                  <div className="SchedGrpInfoChild1">
                    <div className="SchedGrpInfoChild2">
                      ...
                      {this.state.grpData.length &&
                      this.state.grpData[this.state.grpIndex]
                        ? this.state.grpData[this.state.grpIndex].CabCount
                        : 0}
                    </div>
                    <div className="SchedGrpInfoChild2">
                      Restricted Cabs:
              ...
              <div
                className="SchedFileVTogWrp"
                onClick={() => this.setState({ grpFileView: true })}
              >
                <img
                  src={require("../../../Assets/Images/Media/right-arrow.png")}
                  className="SchedBtmArrowImg1"
                ></img>
              </div>
            )}
          </div>
          ...
          >
            {this.state.rightAction > 0 ? (
              ...
              >
                <ul className="actionUl" style={{ "list-style": "none" }}>
                  <li>
                    <div onClick={() => this.setContextMenu("Geozone")}>
                      Update Geozones
                    </div>
                    <div onClick={() => this.setContextMenu("Ratecode")}>
                      Update Rate Codes
                    </div>
                    <div onClick={() => this.setContextMenu("Pickup")}>
                      Update Pickup Geozones
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="SchedGrpMainWrp">
              <div className="SchedGrpTaleWrp">
                {this.state.columnSt && (
                  <ColumnStatus
                    data={this.state.switchcolumns}
                    onChange={(e) => this.setColumn(e, "switchcolumns")}
                    class={"SchedGrpColSt"}
                    onClose={(e) => this.resetColmn(e, "switchcolumns")}
                  ></ColumnStatus>
                )}
                <div className="CabDtTabMainWrp">
                  {this.tabs &&
                ...
                <div className="ScheduleTabToolWrp">
                  ...
                  {this.state.tabIndex === 0 ? (
                    <div style={{ display: "flex" }}>
                      <img
                        src={require("../../../Assets/Images/Schedule/add-video.png")}
                        className="grShedImg"
                        onClick={() =>
                          this.setState({
                            schedVideo: true,
                      ...
                      <img
                        ...
                        className="grShedImg"
                        onClick={() => this.beforeDeletefiles(0)}
                      ></img>
                      <img
                        src={require("../../../Assets/Images/Schedule/copy-video.png")}
                        className="grShedImg"
                        onClick={() => this.copyVideo(0)}
                      ></img>
                    </div>
                  ) : (
                    <div style={{ display: "flex" }}>
                  ...
                  <div className="ScheduleTableToolCont">
                    ...
                    <ExportCSV
                      csvData={this.state.data}
                      fileName={this.state.exportFileName}
                      visibleCol={this.state.switchcolumns}
                      isConversion={true}
                      callback={() => this.getRecords("GroupADSFLFiles/Fetch")}
                    />
                    <img
                      ...
                      return {
                        ...
                        onDoubleClick: () => {
                          ...
                          data.FileDetails = [
                            {
                              GROUP_ADSFL_DETAILID:
                                rowInfo.original.GROUP_ADSFL_DETAILID,
                            },
                          ];
                          data.FileGroups = [
                            {
                          ...
                          if (rowInfo.original.TIMESTART) {
                            var strTimeArr =
                              rowInfo.original.TIMESTART.split(":");
                          ...
                          if (rowInfo.original.TIMEEND) {
                            var endTimeArr =
                              rowInfo.original.TIMEEND.split(":");
                          ...
                          this.setState({
                            ...
                            typeL: rowInfo.original.IndexType,
                            provider: provider,
                            fScreen: rowInfo.original.FULLSCR_NG,
                          });
                        },
                        style: {
                          background:
