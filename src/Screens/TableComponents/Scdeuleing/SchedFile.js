...
const ColumnCol =[
  ...
  {accessor:"FileType",lable:"File Type"},
  {accessor:"FileName",lable:"File Name"},
  {accessor:"Group_ADS_NAME",lable:"Groups"},
  {accessor:"Channel",lable:"Channel"},
  {accessor:"VBannerName",lable:"Verical Banner"},
  {accessor:"HBannerName",lable:"Horizontal Banner"},
  {accessor:"Geozone",lable:"GeoZone"},
  {accessor:"MicroSiteName",lable:"Microsite"},
  ...
  [
    {accessor:"IndexType",lable:"Loop Type"},
     ...
     {accessor:"PickupGeozone",lable:"Pick-Up GeoZones"},
      ...
      {accessor:"VBannerName",lable:"Vertical Banner"},
      {accessor:"HBannerName",lable:"Horizontal Banner"},
      {accessor:"Geozone",lable:"Geozone"},
      {accessor:"MicroSiteName",lable:"Microsite"},
...
const subTabs=["Details","Associated Groups","Associated GeoZones","Associated Rate Codes","Associated Pick-Up GeoZones"];
...
export default class TableGrid extends Component{
  ...
  rateCodesCol=[
    {
        Header:"#",
        Cell: (rowInfo) => <ComCheck onClick={(e)=>e.preventDefault()}  onChange={(e)=>{this.setRateCodes(e,rowInfo.original)}} checked={this.state.rateCodesDt.indexOf(rowInfo.original.ID)>=0}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>, // Custom cell components!
        width:25
    },
    {
        Header:"Rate codes",
    ...
    constructor(props){
         ...
         grpColumn=[
          {
            Header: "#",
            Cell: (rowInfo) => <ComCheck onClick={(e)=>e.preventDefault()}  onChange={(e)=>{this.check=true;this.selGrpRow(e,rowInfo)}}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>, // Custom cell components!
            width:25
          },
          {
        ...
        upColumns=[
          ...
          },
          {
            Header:"Expiry Date",
            accessor:"ExpDate",
            Cell:(rowInfo)=><DatePicker selected={this.getExpDate(rowInfo)} onChange={(date)=>this.setUpldInput(date,rowInfo,"ExpDate")}  wrapperClassName="MediaDatePickWrp" className="MediaDateInptWrp" popperPlacement="right-start"></DatePicker>
          },
          {
            Header:"Content File Type",
            accessor:"ContentFileTypeID",
            Cell:(rowInfo)=> <select className="MediaDropDwn1" onChange={(e)=>this.setUpldInput(e.target.value,rowInfo,"ContentFileTypeID")}>
                         <option value=''></option>
          ...
          },
          {
            Header:"Owner",
            accessor:"OwnerID",
            Cell:(rowInfo)=> <select className="MediaDropDwn1" onChange={(e)=>this.setUpldInput(e.target.value,rowInfo,"OwnerID")}>
                               <option value=''></option>
          ...
          },
          {
            Header:"Tags",
            accessor:"Tag",
            Cell:(rowInfo)=><div className="MeadiaUpldInptwrp"><input className="MediaUpldInpt" onChange={(e)=>this.setUpldInput(e.target.value,rowInfo,"Tag")}></input></div>
          },
          {
            Header:"Contract#",
            accessor:"ContractID",
            Cell:(rowInfo)=><div className="MeadiaUpldInptwrp"><input className="MediaUpldInpt"  min="1" onChange={(e)=>this.setUpldInput(e.target.value,rowInfo,"ContractID")}></input></div>
          },
          {
            Header:"Commited Impression",
            accessor:"Commited",
            Cell:(rowInfo)=><div className="MeadiaUpldInptwrp"><input className="MediaUpldInpt"  min="1" onChange={(e)=>this.setUpldInput(e.target.value,rowInfo,"Impression")}></input></div>
          },
          {
            ...
            Cell:(props)=><div className={props.original.Code?"":"ProgressBrWrp"}>
                {
                    props.original.Code?
                        ...
                        :
                        <Line percent={props.original.progress} strokeWidth="1" strokeColor="#80BBD7" trailColor="#FFFFFF" className="SystUProgress"/>
          ...
          {
              Header: "",
              Cell: (rowInfo) =><div style={{paddingBottom:"10px"}}> <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg1" onClick={()=>this.deleteRow(rowInfo)}></img></div>, // Custom cell components!
              width:35
          },
      ...
      setSwicthCol(colData,type){
            ...
            colData.map((key,index)=>{
              ...
              if(key.accessor === "FileType"){
                ...
                obj={
                  ...
                  show:true,
                  filterable:true,
                  filterMethod: (filter, row,rowInfo) => {
                    if(filter.value === ""){
                        return true
                    }
                    if(row[filter.id]){
                ...
                //     </div>,
                    ...
                    <span className="SystFlColTxt">{rowInfo.original[key.accessor]}</span>
                    {
                      key.accessor === "VBannerName" || key.accessor ==="HBannerName" ||  key.accessor === "VFileDisplayName" || key.accessor === "HFileDisplayName" ?
                          ...
                          <img onMouseMove={()=>this.showImgToolTip(key.accessor === "VBannerName" || key.accessor === "VFileDisplayName" ?rowInfo.original.WebVisibleURLVBanner:rowInfo.original.WebVisibleURLHBanner)} onMouseLeave={()=>this.hideImgToolTip("")} src={rowInfo.original[key.accessor]?require("../../../Assets/Images/Media/image-preview.png"):""} className="MediaFlColDnldImg"></img>

                      :
                      rowInfo.original.FileType === 0 ?
                      <img src={require("../../../Assets/Images/Media/video-preview.png")} onClick={()=>this.showPreview(rowInfo.original.WebVisibleURL)} className="MediaFlColDnldImg"></img>
                      :
                          <div></div>
                      ...
                      Cell:(rowInfo)=><div className="SystFlColContainer geoZoneCell">
                          {
                              ...
                              <img src={require("../../../Assets/Images/Schedule/geoZone.PNG")} className="MediaFlColDnldImg"></img>
                          }
        ...
        if(type === "nonGroup"){
          ...
          Cell: (rowInfo) =><div style={{paddingBottom:"10px"}}>{
            ...
            <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg1" onClick={(()=>this.deleteSchedFile(rowInfo.original))}></img>
          ...
          let obj = {
            Header: "#",
            Cell: (rowInfo) => <div className="SchedCheck"><ComCheck  onChange={(e)=>this.setDelete(rowInfo.index)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"} checked={false}></ComCheck></div>, // Custom cell components!
            width:25
          }
          dColumn.splice(0,0,obj)

          this.setState({switchcolumns:dColumn,group:true,loading:false},()=>this.getRecords("GroupADSFLFiles/Fetch"));
        }
                  ...
                  if(key.accessor === "IndexType"){
                    obj={
                        ...
                        Filter: (cellInfo) =>
                            <div>{
                                this.state.visibleFilters.indexOf(cellInfo.column.id) >= 0 &&
                                <MultiChoice keyData={loopType} choice={this.state.loopMulti} setChoice={(e,key)=>this.setChnlFilter(e,key,cellInfo.column.id,index,"loopMulti",loopType)}></MultiChoice>
                            }
                            </div>,
                        Cell:(rowInfo)=><span>{loopType[rowInfo.original.IndexType]}</span>
    ...
    getRecords(url) {
            ...
            if (this.state.grpData && this.state.grpData.length === 0) {
                ...
                getData(tabsUrl[this.state.tabIndex] + this.state.grpId)
                    ...
                    if (res && res.data && res.data.ResponseCollection) {
                            this.setState({data: res.data.ResponseCollection, flLoading: false,deletData:[],grpViewLoading:false,systProgCnt: 0}, () => {

                            })
                        } else {
                            this.setState({data: [],deletData:[],flLoading: false,grpViewLoading:false})
                        }
                    })
            }
        }
            ...
            postData(url, obj)
                .then((res) => {
                    if (res && res.data && res.data.ResponseCollection) {
                        ...
                        this.setState({data: [],deletData:[],flLoading: false})
                    }
                })
        }
      ...
      getGrpData(url,type){
       ...
       .then((res)=>{
          ...
          this.setState({grpData:res.data.ResponseCollection,grp1Data:res.data.ResponseCollection,grpId:res.data.ResponseCollection[0].Group_ADS_ID,grpLoading:false,deletData:[],grpDelete:[]})
          if(this.state.group){
            this.getRecords();
          }
        }else{
                ...
                .then((res)=>{
                    ...
                    if(res && res.data && res.data.ResponseCollection){
                        if(res.data.ResponseCollection.length>0){
                            this.setState({geoZoneData:res.data.ResponseCollection,geoZone1Data:res.data.ResponseCollection,GeoZoneId:res.data.ResponseCollection[0].ID})
                        }
                    }else{
...
getHouseData(){
        ...
        if(data.FileType === 0){
         ...
         .then(res=>{
           if(res.data.ReturnCode === 0){
            this.setState({dlgtitle:"Information",message:"Deleted Successfully",dlgType:"information",dlgEnable:true},()=>this.getRecords("GroupADSFLFiles/Fetch"))
           }else{
            this.setState({flLoading:false})
           }
         })
    ...
    setGroup(val){
      if(val){
        this.setState({group:val,loading:true,columnSt:false,grpFileView:false,collapse:true,grpDelete:[],flEditData:[],FlDtIndex:0},()=> this.setSwicthCol(swictCol[this.state.tabIndex],"Group"))
      }else{
        this.setState({group:val,loading:true,columnSt:false,grpFileView:false,collapse:false,grpDelete:[],flEditData:[],FlDtIndex:0},()=> this.setSwicthCol(ColumnCol,"nonGroup"))
      }
    }
    ...
    setLoadFile(data){
      if(this.filterType === 1){
        ...
        if(this.state.schedVideo){
          ...
          /*if(data.Banner1){
            this.addobj["Banner1"]=data.Banner1
          }*/
          ...
          /*if(data.Banner1){
            this.state.flEditData.Banner1=data.Banner1
          }*/
        ...
        if(this.state.schedVideo){
          ...
          /*if(data.Banner2){
            this.addobj["Banner2"]=data.Banner2
          }*/
    ...
    resetEditState(){
        ...
        this.setState({flEditData:{},typeL:0,provider:0,fScreen:0});
    ...
    addDeails(){
        ...
        if(msg === ""){
            ...
            postData(url,obj)
                .then(res=>{
                    if(res.data && res.data.ReturnCode===0){
                        this.setState({dlgtitle:"Information",message:"Update Successfully",dlgType:"information",dlgEnable:true,btmDetails:false,flEditData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"))
                        this.resetEditState();
                    }else{
                        this.setState({dlgtitle:"Information",message:"Failed please try again",dlgType:"information",dlgEnable:true,btmDetails:false,flEditData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"))
                    }
                })
        }else{
            this.setState({dlgtitle:"Information",message:msg,dlgType:"information",schedEdit:true});
    ...
    editLoadFile(){
     ...
     if(this.state.editGrFile){
        ...
        }else if(type === 1 && this.state.flEditData.WebVisibleURLHBanner === ""){
            msg="Please Select Horizontal Banner";
        }else if(this.state.flEditData.WebVisibleURLHBanner !== "" && this.state.flEditData.WebVisibleURLVBanner === ""){
            msg="Please Select Vertical Banner";
        }else if(this.state.flEditData.WebVisibleURLHBanner === "" && this.state.flEditData.WebVisibleURLVBanner !== ""){
            msg="Please Select Horizontal Banner";
        }
        ...
        if(type === 0 && this.state.flEditData.Microsite && this.state.flEditData.Microsite>0 && this.state.flEditData.VideoMicrosite==false){
            if(this.state.flEditData.WebVisibleURLHBanner == "" || this.state.flEditData.WebVisibleURLVBanner== "") {
                msg = "Microsite can only be scheduled either with VB and HB or video";
            }else if(this.state.flEditData.WebVisibleURLHBanner !== "" && this.state.flEditData.WebVisibleURLVBanner === ""){
                msg="Microsite can only be scheduled either with VB and HB or video";
            }else if(this.state.flEditData.WebVisibleURLHBanner === "" && this.state.flEditData.WebVisibleURLVBanner !== ""){
                msg="Microsite can only be scheduled either with VB and HB or video";
        ...
        if(msg === ""){
            ...
            postData(url,obj)
                .then(res=>{
                    if(res.data && res.data.ReturnCode===0){
                        this.setState({dlgtitle:"Information",message:"Update Successfully",dlgType:"information",dlgEnable:true,editFile:false,editGrFile:false,flEditData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"))
                        this.resetEditState();
                    }else{
                        this.setState({dlgtitle:"Information",message:"Failed please try again",dlgType:"information",dlgEnable:true,editFile:false,flEditData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"))
                    }
                })
        }else{
  ...
  setUpldInput(val,rowInfo,type){
    if(type === "ExpDate"){
        ...
        if(dt1 >= dt2){
            ...
            this.setState({dlgtitle:"Information",message:"Expiry date cannot less than current date",dlgType:"information",upLoadvalidMsg:true})
        }
    ...
    getResUploadFileOnServer(fileData){
     ...
     uploadMultiFiles(){
         if(this.state.uplddata.length > 0){
             ...
             this.setState({dlgtitle:"Information",message:"Please select file..",dlgType:"information",upLoadvalidMsg:true})
         }
     }
               ...
               .then(res=>{
                   ...
                   if(res.data && res.data.ReturnCode===0){
                       ...
                       if(res.data.ReturnCode===4){
                           this.setState({dlgtitle:"Information",message:"File with the same name already exists...",dlgType:"information",dlgEnable:true,upload:false,uplddata:[],selectedFiles:[]})
                       }else{
  ...
  upDateFiles(){
    ...
    .then(res=>{
        this.setState({fileUplaodLoding:false});
        if(res.data && res.data.ReturnCode===0){
          this.setState({dlgtitle:"Information",message:"File Uploaded Successfully",dlgType:"information",dlgEnable:true,upload:false,uplddata:[],selectedFiles:[],systProgCnt:0,uplddata:[],expDate:this.comnExpDate})
  ...
  setEditData(rowInfo){
    this.setState({flEditData:rowInfo.original,editFile:true,channel:rowInfo.original.Channel,fLength:rowInfo.original.Len})
  }
  ...
  setGrpIndex(index,type){
    ...
    setGeoZoneSelection(type){
        ...
        if(type === "add" && this.state.geoZoneIndex.length > 0){
            ...
            this.setState({geoZone2Data:unqArray,grp2Index:[],adujstRow:tempEmptyRow});
        }
    }
    ...
    setGroupSelection(type){
        ...
        if(type === "add" && this.state.grp1Index.length > 0){
            ...
            this.setState({grp2Data:unqArray,grp2Index:[],adujstRow:tempEmptyRow});
        }
    }
        ...
        if(this.state.flEditData.FileType==0){
           ...
           console.log(this.state.selectedRow)
            postData(url,obj)
                .then(res=>{
                    if(res.data && res.data.ReturnCode===0){
                        this.setState({dlgtitle:"Information",message:"Geozones Associated Successfully",dlgType:"information",dlgEnable:true,btmGeoZoneAssociation:false,flEditData:[],geoZone2Data:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"));

                    }else{
                        this.setState({dlgtitle:"Information",message:"Failed please try upload again",dlgType:"information",dlgEnable:true,btmGeoZoneAssociation:false,flEditData:[],geoZone2Data:[]})
                    }
  ...
  associateGroupsTofile(){
      ...
      if(this.state.flEditData.FileType==0){
          ...
          postData(url,obj)
              .then(res=>{
                  if(res.data && res.data.ReturnCode===0){
                      this.setState({dlgtitle:"Information",message:"Groups Associated Successfully",dlgType:"information",dlgEnable:true,btmGrpAssociated:false,flEditData:[],grp2Data:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"));

                  }else{
                      this.setState({dlgtitle:"Information",message:"Failed please try upload again",dlgType:"information",dlgEnable:true,btmGrpAssociated:false,flEditData:[],grp2Data:[]})
                  }
  ...
  associatedRateCodestoFile(){
     if(this.state.rateCodesDt){
        ...
        .then(res=>{
            if(res.data && res.data.ReturnCode===0){
                this.setState({dlgtitle:"Information",message:"Rate Codes Associated Successfully",dlgType:"information",dlgEnable:true,btmRateCodes:false,rateCodesDt:[]},()=>this.getRecords("GroupADSFLFiles/Fetch","refresh"));

            }else{
                this.setState({dlgtitle:"Information",message:"Failed please try again",dlgType:"information",dlgEnable:true,btmRateCodes:false,rateCodesDt:[]})
            }
  ...
  schedValid(type){
    ...
    if(type === 0 && this.addobj.WebVisibleURL === ""){
      msg="Please Select video file"
    }else if(type === 1 && this.addobj.WebVisibleURLHBanner === ""){
      msg="Please Select Horizontal Banner";
    }else if(this.addobj.WebVisibleURLHBanner !== "" && this.addobj.WebVisibleURLVBanner === ""){
      msg="Please Select Vertical Banner";
    }else if(this.addobj.WebVisibleURLHBanner === "" && this.addobj.WebVisibleURLVBanner !== ""){
      msg="Please Select Horizontal Banner";
    }
    ...
    if(this.addobj.WebVisibleURLHBanner !== "" || this.addobj.WebVisibleURLVBanner!== ""){
        if(this.state.fScreen==1){
          ...
          if(type === 0 && this.state.mSite && this.state.mSite>0 && this.state.VideoMicrosite==false){
              if(this.addobj.WebVisibleURLHBanner == "" || this.addobj.WebVisibleURLVBanner== "") {
                  msg = "Microsite can only be scheduled either with VB and HB or video";
              }else if(this.addobj.WebVisibleURLHBanner !== "" && this.addobj.WebVisibleURLVBanner === ""){
                  msg="Microsite can only be scheduled either with VB and HB or video";
   ...
   checkSelectedGroupLength(){
       if(this.state.grp2Data.length > 0){
           ...
           this.setState({dlgtitle:"Information",message:"Please select groups",dlgType:"information",GrSelectionInfo:true})
       }
   }
  schedVideo(){
    ...
    .then(res=>{
        ...
        if(res.data && res.data.ReturnCode===0){
        this.setState({dlgtitle:"Information",message:"Added Successfully",dlgType:"information",dlgEnable:true,grpSelection:false,flEditData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"));

      }else{
        this.setState({dlgtitle:"Information",message:"Failed please try upload again",dlgType:"information",dlgEnable:true,grpSelection:false,flEditData:[]})
      }
     this.resetFlDetails()
    }).catch((e)=>{
        this.setState({isbusy:false});
  ...
  deleteFiles(type){
    ...
    if(this.state.deletData.length > 0){
     ...
     .then(res=>{
       if(res.data && res.data.ReturnCode===0){
         this.setState({dlgtitle:"Information",message:"Deleted Successfully",dlgType:"information",dlgEnable:true,deletData:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"));

       }else{
         this.setState({dlgtitle:"Information",message:"Faild please try  again",dlgType:"information",dlgEnable:true,})
       }
     })
    }else{
      this.setState({dlgtitle:"Information",message:"Please Select files",dlgType:"information",dlgEnable:true,grpSelection:false,flEditData:[]})
    }
    ...
    this.state.grpObj.groupName = gName;
     ...
     if(msg){
         ...
         postData('GroupADSFL/Update', obj)
             .then(res =>{
                 if(res.data && res.data.ReturnCode===0){
                     this.setState({grpInfo: false, grpObj : {groupName: '', startDate : '', endDate : '', unitType : ''}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                     this.setState({dlgtitle:"Information",message:"Added Successfully",dlgType:"information",dlgEnable:true,});
                 }else{
                       if(res.data && res.data.ReturnCode===4){
                           this.setState({grpInfo: false, grpObj : {groupName: '', startDate : '', endDate : '', unitType : ''}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                           this.setState({dlgtitle:"Information",message:"Group with the same name already exists",dlgType:"information",dlgEnable:true,});
                       }else{
                           this.setState({grpInfo: false, grpObj : {groupName: '', startDate : '', endDate : '', unitType : ''}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                           this.setState({dlgtitle:"Information",message:"Internal Server Error",dlgType:"information",dlgEnable:true,});
                       }
    ...
    editGroupToDatabase = () =>{
        ...
        if(msg){
            ...
            postData('GroupADSFL/Update', obj)
                .then(res =>{
                    if(res.data && res.data.ReturnCode===0){
                        this.setState({grpEditInfo: false, groupEditData : {}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                        this.setState({dlgtitle:"Information",message:"Group Updated Successfully",dlgType:"information",dlgEnable:true,});
                    }else{
                        if(res.data && res.data.ReturnCode===4){
                            this.setState({grpEditInfo: false, grpObj : {}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                            this.setState({dlgtitle:"Information",message:"Group with the same name already exists",dlgType:"information",dlgEnable:true,});
                        }else{
                            this.setState({grpEditInfo: false, grpObj : {}},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                            this.setState({dlgtitle:"Information",message:"Internal Server Error",dlgType:"information",dlgEnable:true,});
...
handleDeleteGrp = () => {
  if(this.state.grpDelete.length > 0){
      ...
      postData('GroupADSFL/Update', obj)
          .then(res =>{
              if(res.data && res.data.ReturnCode===0){
                  this.setState({dataLoading : true, grpDelete : []},()=>this.getGrpData("GroupADSFL/Fetch","get"));
                  let msg=""
    ...
    this.setState({dlgtitle:"Information",message:"Please Select Groups",dlgType:"information",dlgEnable:true,})
  }
}
    ...
    updategroupStatus(value){
        ...
        postData('GroupADSFL/ChangeGroupStatus', obj)
            .then(res =>{
                ...
                if(res.data && res.data.ReturnCode===0){
                    this.setState({display : 0,grpData:[], grpDelete : []},()=>this.getGrpData("GroupADSFL/Fetch","get"))
                    this.setState({dlgtitle:"Information",message:"Status Updated Successfully",dlgType:"information",dlgEnable:true,});
                }
            });
    }
...
copyVideo(type){
  if(this.state.deletData.length > 0 && this.state.grpDelete.length > 0){
    ...
    .then(res=>{
      if(res.data.ReturnCode === 0){
        this.setState({dlgtitle:"Information",message:"Copied Successfully",dlgType:"information",dlgEnable:true,grpData:gData,grpLoading:false,deletData:[],grpDelete:[]},()=>{
          this.setSwicthCol(swictCol[this.state.tabIndex],"Group","fetchGrp");
          this.getRecords("GroupADSFLFiles/Fetch");
        })
      }else{
        this.setState({dlgtitle:"Information",message:"Failed please try again",dlgType:"information",dlgEnable:true,deletData:[],grpDelete:[],grpData:gData,grpLoading:false},()=>{
          this.setSwicthCol(swictCol[this.state.tabIndex],"Group","fetchGrp")
        })
      }
    })
...
resetFlDetails(){
  this.setState({fScreen:0,VideoMicrosite:false, order:1,mSite:0,dateStart:new Date(),dateEnd:new Date(),channel:0,typeL:0,timeEndhr:23,timeEndmin:59,timeSrthr:0,timeSrtmin:0,fLength:0,grp1Index:[],grp2Index:[],grp2Data:[],schedVideo:false,schedBanner:false,grpSelection:false,provider:0})
  this.addobj={
    VBannerName:"",
    HBannerName:"",
    FileName:"",
...
seteditchannet(channel){
    ...
    handleRowClick = (e, data) =>{
        ...
        if(e.original){
            ...
            this.setState({selectedGroupData:e.original,groupVideoCount:e.original.VideoCount,groupBannerCount:e.original.BannerCount});
           ...
           <div>
               {
                   ...
                   :this.state.schedBanner ?
                        <div className="Loader">
                            <div className="SchedBnrWrp" draggable={true}>
                              ...
                              <div className="SchedBnrInptWrp">
                                  ...
                                  <div className="RightDiv-md2">
                                      <input style={{"width":"55%"}} className="SchedBnrPopinpt" type="number" min="1" max="65535" value={this.state.order} onChange={(e)=>this.setState({order:e.target.value})}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                  </div>
                                  <div className="RightDiv-md2">
                              ...
                              <div className="SchedBnrInptWrp">
                                  ...
                                  <div className="RightDiv-md2">
                                      <select style={{"width":"59%"}} className="SchedDropDwn1" onChange={(e)=>this.setState({channel:e.target.value})} value={this.state.channel}>
                              ...
                              <div className="SchedEdtFileTopWrp">
                                  <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(3,"Vbanner","Bsched")}>
                                          ...
                                          this.addobj && this.addobj.WebVisibleURLVBanner?
                                              <div>
                                                  <div className="SchedBnrpopImgWrp">
                                                      <img src={this.addobj.WebVisibleURLVBanner} className="SchedBnrpopImg_V"></img>
                                                      <div className="SchedBnrpopImgOvrWrp">
                                                          <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation();this.setschedLoadFiles(2)}}></img>
                                                      </div>
                                                  </div>
                                                  <span className="SchedBnrPopImgTypetxt1">{this.addobj.VBannerName}</span>
                                              </div>
                                              :
                                              <div>
                                                  <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                                  <span className="SchedBnrPopImgTypetxt1">{this.addobj.VBannerName?this.addobj.VBannerName:"No Image"}</span>
                                              </div>
                                      }
                                      {
                                ...
                                <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(2,"Hbanner","Bsched")}>
                                  <span className="SchedBnrPopImgTypetxt">Horizontal Banner</span>
                                  {
                                      this.addobj && this.addobj.WebVisibleURLHBanner?
                                      <div>
                                          <div className="SchedBnrpopImgWrp">
                                           <img src={this.addobj.WebVisibleURLHBanner} className="SchedBnrpopImg_H"></img>
                                           <div className="SchedBnrpopImgOvrWrp">
                                              <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation();this.setschedLoadFiles(1)}}></img>
                                           </div>
                                          </div>
                                          <span className="SchedBnrPopImgTypetxt1">{this.addobj.HBannerName}</span>
                                      </div>
                                      :
                                      <div>
                                          <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                          <span className="SchedBnrPopImgTypetxt1">{this.addobj.HBannerName?this.addobj.HBannerName:"No Image"}</span>
                                       </div>
                                    }
                              ...
                              <div className="SchedBnrPopImgWrp2">
                                  ...
                                  <div className="RightDiv-md2">
                                      <DatePicker selected={this.state.dateStart} onChange={(date)=>this.setState({dateStart:date})} wrapperClassName=""  className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                                  </div>
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt">Date End *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <DatePicker selected={this.state.dateEnd} onChange={(date)=>this.setState({dateEnd:date})} wrapperClassName="" className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                                  </div>
                              ...
                              <div className="SchedBnrPopImgWrp2" style={{marginTop:"13px"}}>
                                  ...
                                  <div className="RightDiv-md2">
                                      <input className="SchedBnrPopinpt2" type="number" min="0" max="23" value={this.state.timeSrthr} onChange={(e)=>this.setState({timeSrthr:e.target.value})}></input>
                                      <input className="SchedBnrPopinpt2" type="number" min="0" max="59" value={this.state.timeSrtmin} onChange={(e)=>this.setState({timeSrtmin:e.target.value})}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:"2%"}}>Time End *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <input className="SchedBnrPopinpt2" type="number" min="0" max="23" value={this.state.timeEndhr} onChange={(e)=>this.setState({timeEndhr:e.target.value})}></input>
                                      <input className="SchedBnrPopinpt2" type="number" min="0" max="59" value={this.state.timeEndmin} onChange={(e)=>this.setState({timeEndmin:e.target.value})}></input>
                                  </div>
                              </div>
                              <div className="SchedBnrPopImgWrp2">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{"padding-right":"5px"}} >Microsite</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <select style={{"width":"59%"}} className="SchedDropDwn1" onChange={(e)=>this.setState({mSite:e.target.value})} value={this.state.mSite}>
                              ...
                              <div className="SchedBnrPopImgWrp2">
                                  ...
                                  <div className="RightDiv-md2">
                                      <input style={{"width":"59%","margin-left":"4px"}} min="1" max="65535" className="SchedBnrPopinpt" type="number" value={this.state.fLength} onChange={(e)=>this.setState({fLength:e.target.value})}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                  </div>
                                  <div className="RightDiv-md2">
                              ...
                              <div className="SchedPopBtnWrp1">
                                <img style={{paddingRight:"10px"}} src={require("../../../Assets/Images/next-btn.png")} className="" onClick={()=>this.schedValid(1)} ></img>
                                <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className=""  onClick={()=>this.resetFlDetails()}></img>
                                     ...
                                     <div className="SchedLodFlWrp">

                                       {
                                         this.state.loadFileData && this.state.loadFileData.map((key,index)=>(
                                           ...
                                           <div className="SchedLodFlChildWrp" onDoubleClick={()=>this.setLoadFile(key)}>
                                               {key.ContentTypeID}
                            ...
                            {
                             this.state.schedVal &&
                            <Dialog title={this.state.dlgtitle} message={this.state.message} onOk={()=>this.setState({schedVal:false})} onHide={()=>this.setState({schedVal:false})}/>
                          }
                        </div>
                        ...
                        <div className="Loader">
                            <div className="SchedBnrWrp1" draggable={true}>
                               ...
                               <div className="SchedEdtFileTopWrp1">
                                <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(1,"video","Vsched")}>
                                    <span className="SchedBnrPopImgTypetxt">File</span>
                                    {
                                      this.addobj && this.addobj.WebVisibleURL?
                                      <div>
                                          <div className="SchedBnrpopImgWrp">
                                           <img src={this.getThumnail(this.addobj.WebVisibleURL)} className="SchedBnrpopImg"></img>
                                           <div className="SchedBnrpopImgOvrWrp">
                                              <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation();this.setschedLoadFiles(0)}}></img>
                                           </div>
                                          </div>
                                      ...
                                      <div>
                                          <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                          <span className="SchedBnrPopImgTypetxt2">{this.addobj.FileName?this.addobj.FileName:"No image"}</span>
                                       </div>
                                    }

                                  </div>
                                   <div className="SchedEdtFileTopChild" onClick={(e)=>{ e.preventDefault(); this.loadFiles(3,"Vbanner","Vsched")}}>
                                       <span className="SchedBnrPopImgTypetxt">Vertical Banner</span>
                                       {
                                           this.addobj && this.addobj.WebVisibleURLVBanner?
                                               <div>
                                               ...
                                               <div>
                                                   <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                                   <span className="SchedBnrPopImgTypetxt2">{this.addobj.VBannerName?this.addobj.VBannerName:"No image"}</span>
                                               </div>
                                       }
                                       {
                                           this.state.typeL === 3 ||  this.state.typeL === "3" || this.state.VideoMicrosite==true ?
                                           <div onClick={(e)=>e.stopPropagation()}  className="SchedDisbleWrp" disabled={true}></div>
                                           :
                                               <div></div>
                                       }

                                   </div>
                                <div className="SchedEdtFileTopChild" onClick={(e)=>{e.preventDefault();this.loadFiles(2,"Hbanner","Vsched")}}>
                                  <span className="SchedBnrPopImgTypetxt">Horizontal Banner</span>
                                  {
                                      this.addobj && this.addobj.WebVisibleURLHBanner?
                                      <div>
                                      ...
                                      <div>
                                          <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                          <span className="SchedBnrPopImgTypetxt2">{this.addobj.HBannerName?this.addobj.HBannerName:"No image"}</span>
                                       </div>
                                    }
                              ...
                              <div className="SchedBnrInptWrp">
                                  ...
                                  <div className="RightDiv-md2">
                                      <select style={{width:"59%"}} className="" onChange={(e)=>this.setState({channel:e.target.value})} value={this.state.channel}>
                                          <option value={0}>ALL</option>
                                          <option value={1}>NBC</option>
                                          <option value={2}>NYCM</option>
                                      </select>
                                  ...
                                  <div className={this.state.typeL==0 ? "RightDiv-md2":"RightDiv-md2 disableDiv"}>
                                      <select style={{width:"85%"}} className="" onChange={(e)=>this.setState({provider:e.target.value})} value={this.state.provider}>
                                          <option value={""}></option>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt1" style={{marginLeft:"6.5%"}}>Order *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <input style={{width:"55%"}} type="number" min="1" max="65535" value={this.state.order} onChange={(e)=>this.setState({order:e.target.value})}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                  </div>
                                  <div className="RightDiv-md2">
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:"4.5%"}}>Date Start *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <DatePicker selected={this.state.dateStart} onChange={(date)=>this.setState({dateStart:date})} wrapperClassName="" className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                                  </div>
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:"10%"}}>Date End *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <DatePicker selected={this.state.dateEnd} onChange={(date)=>this.setState({dateEnd:date})} wrapperClassName="" className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                                  </div>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:'-1.5%',marginTop:"10px"}}>Full Screen *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <select style={{width:"43%"}}  className="SchedDropDwn1" onChange={(e)=>this.setFullScreenOpt(e)} value={this.state.fScreen}>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:'4%',marginTop:"10px"}}>Microsite</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                  ...
                                  <div style={{paddingLeft:"22px","marginTop":"6px"}} className="RightDiv-md2">
                                      {
                                          this.state.typeL == 0 ?
                                              <div>
                                              <input type="checkbox" id="allEmployeesCheckBox" name="allEmployeesCheckBox" className="styled pending-assign-user"
                                                     checked={this.state.VideoMicrosite} onChange={(e)=>{this.checkAutoDispaly(e)}}>

                                              </input>
                                              <span  className="SchedBnrPopTxt" style={{marginLeft:'5%'}} >Auto Display</span>
                                              </div>
                                              :<span></span>
                                      }
                                  </div>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span  className="SchedBnrPopTxt" style={{marginLeft:'5%'}} >Length *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <input style={{width:"43%"}} className="SchedBnrPopinpt" type="number" disabled={true}  value={this.state.fLength}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                  </div>
                                  <div className="RightDiv-md2">
                              ...
                              <div className="SchedPopBtnWrp">
                                  {
                                      this.state.group ?
                                          <img style={{"paddingRight":"10px","cursor": "pointer"}} src={require("../../../Assets/Images/ok-btn.png")}
                                               className={!this.state.isenableschedBtn?"ForgPassBtn disabledBtn":"ForgPassBtn"}
                                               disabled={!this.state.isenableschedBtn}
                                               onClick={()=>this.schedValid(0)}></img>
                                          :
                                          <img style={{"paddingRight":"10px","cursor": "pointer"}} src={require("../../../Assets/Images/next-btn.png")}
                                               className={!this.state.isenableschedBtn?"ForgPassBtn disabledBtn":"ForgPassBtn"}
                                               disabled={!this.state.isenableschedBtn}
                                               onClick={()=>this.schedValid(0)}></img>
                                  }

                                <img style={{"cursor": "pointer"}} src={require("../../../Assets/Images/Login/cancel-btn.png")} className="ForgPassBtn"  onClick={()=>this.resetFlDetails()}></img>
                                  <div style={{"width":"7%"}}></div>
                            </div>
                            </div>
                            {
                        ...
                        <div className="Loader">
                          <div className="SchedBnrWrp1">
                              ...
                              <div className="SchedEdtFileTopWrp">
                                {
                                  ...
                                  <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(1,"video")}>
                                  <span className="SchedBnrPopImgTypetxt">File</span>
                                  {
                                    this.state.flEditData &&  this.state.flEditData.WebVisibleURL?
                                    <div>
                                        <div className="SchedBnrpopImgWrp">
                                        <img src={this.getThumnail(this.state.flEditData.WebVisibleURL)} className="SchedBnrpopImg"></img>
                                            <div className="SchedBnrpopImgOvrWrp">
                                                <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation(); this.setschedLoadFiles(0)}}></img>
                                            </div>
                                        </div>
                                        <span className="SchedBnrPopImgTypetxt1">{this.state.flEditData.FileName}</span>
                                    </div>
                                    :
                                    <div>
                                        <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                        <span className="SchedBnrPopImgTypetxt1">{this.state.flEditData.FileName?this.state.flEditData.FileName:"No Image"}</span>
                                     </div>
                                  }

                                </div>
                                }
                                  <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(3,"Vbanner")}>
                                      <span className="SchedBnrPopImgTypetxt">Vertical Banner</span>
                                      {
                                          this.state.flEditData && this.state.flEditData.WebVisibleURLVBanner?
                                              <div>
                                                  ...
                                                  <img src={this.state.flEditData.WebVisibleURLVBanner} className="SchedBnrpopImg_V"></img>
                                                      <div className="SchedBnrpopImgOvrWrp">
                                                          <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation(); this.setschedLoadFiles(2)}}></img>
                                                      </div>
                                                  </div>
                                                  <span className="SchedBnrPopImgTypetxt1">{this.state.flEditData.VBannerName}</span>
                                              </div>
                                              :
                                              <div>
                                                  <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                                                  <span className="SchedBnrPopImgTypetxt1">{this.state.flEditData.VBannerName?this.state.flEditData.VBannerName:"No Image"}</span>
                                              </div>
                                      }
                                      {
                                          this.state.typeL == 3 ||  this.state.typeL == "3" || this.state.flEditData.VideoMicrosite ?
                                          <div onClick={(e)=> e.stopPropagation() } className="SchedDisbleWrp"></div>
                                              :<div></div>
                                      }
                                  </div>
                                <div className="SchedEdtFileTopChild" onClick={()=>this.loadFiles(2,"Hbanner")}>
                                  <span className="SchedBnrPopImgTypetxt">Horizontal Banner</span>
                                  {
                                      this.state.flEditData && this.state.flEditData.WebVisibleURLHBanner?
                                      <div>
                                          <div className="SchedBnrpopImgWrp">
                                          <img src={this.state.flEditData.WebVisibleURLHBanner} className="SchedBnrpopImg_H"></img>
                                              <div className="SchedBnrpopImgOvrWrp">
                                                  <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg3" onClick={(e)=>{e.stopPropagation(); this.setschedLoadFiles(1)}}></img>
                                              </div>
                                          </div>
                                          <span className="SchedBnrPopImgTypetxt1">{this.state.flEditData.HBannerName}</span>
                                      </div>
                                      :
                                      <div>
                                          <img src={require("../../../Assets/Images/images.jpg")} className="SchedBnrpopImg"></img>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:"3%"}}>Channel *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <select className="SchedDropDwn1" onChange={(e)=>this.seteditchannet(e.target.value)} value={this.state.channel}>
                                          <option value={0}>ALL</option>
                                          <option value={1}>NBC</option>
                                          <option value={2}>NYCM</option>
                                      </select>
                                  ...
                                  {
                                      this.state.editGrFile && this.state.flEditData.FileType === 0 &&

                                      <div className="leftDiv-md2">
                                              <span className="SchedBnrPopTxt"
                                                    style={{marginLeft: "8%"}}>Provider</span>
                                      </div>
                                  }
                                  {this.state.editGrFile && this.state.flEditData.FileType === 0 &&
                                          <div
                                              className={this.state.typeL == 0 ? "RightDiv-md2" : "RightDiv-md2 disableDiv"}>
                                              <select style={{width: "85%"}} className="" onChange={(e) => {
...

                                                  {
                                                      this.state.providerData.map((key, index) => {
                                                          return (
                                                              <option
                                                                  value={key.Provider_ID}>{key.Provider_Name}</option>
                                                          )
                                                      })
                                                  }
                                              </select>
                              ...
                              </div>
                              {
                                  ...
                                  <div className="SchedBnrInptWrp">
                                      ...
                                      <div className="RightDiv-md2">
                                          <input style={{width: "55%"}} type="number" min="1" max="65535"
                              ...
                              }
                              {
                                  ...
                                  <div className="SchedBnrInptWrp">
                                      ...
                                      <div className="RightDiv-md2">
                                          <select style={{width: "43%"}} className="SchedDropDwn1"
                                                  onChange={(e) => this.setFullScreenOpt(e)} value={this.state.fScreen}>
                                              <option value={1}>True</option>
                                              <option value={0}>false</option>
                                          </select>
                                      </div>
                              ...
                              <div className="SchedBnrInptWrp">
                                  <div className="leftDiv-md2"  >
                                      <span className="SchedBnrPopTxt" style={{marginRight:'17px',marginTop:"10px"}}>Microsite</span>
                                  </div>
                                  <div className="RightDiv-md2" style={{marginLeft:'-5px'}}>

                                      <select style={{"width":"59%"}} className="SchedDropDwn1" onChange={(e)=>{this.setState({mSite:e.target.value}); this.state.flEditData.Microsite=e.target.value}} value={this.state.flEditData.Microsite?this.state.flEditData.Microsite:this.state.mSite}>
                                          <option value={0}></option>
                                          {
                                              this.state.micrositeList.map((key, index) =>{
                                                  return (
                                          ...
                                          <div style={{marginLeft:"22px",marginTop:"6px"}}>
                                              {
                                                  this.state.typeL == 0 ?
                                                      <div>
                                                          <input type="checkbox" id="allEmployeesCheckBox" name="allEmployeesCheckBox" className="styled pending-assign-user"
                                                                 checked={this.state.flEditData.VideoMicrosite} onChange={(e)=>{this.checkAutoDispaly(e)}}>
                              ...
                              <div className="SchedBnrInptWrp">
                                  ...
                                  <div className="RightDiv-md2">
                                      <input style={{"width":"45%",opacity:"0.5"}} className="SchedBnrPopinpt" disabled={this.state.flEditData.FileType === 0?true:false} type="number" onChange={(e)=>this.setState({fLength:e.target.value})} value={this.state.flEditData.Len} min="0"></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                  </div>
                                  <div className="RightDiv-md2">
                              ...
                              <div className={this.state.editGrFile?"SchedEditBtnWrp videoEditMargin":"SchedEditBtnWrp"} >
                          ...
                          </div>
                          {
                            ...
                            {
                                this.state.schedEdit &&
                                <Dialog title={this.state.dlgtitle} message={this.state.message} onOk={()=>this.setState({schedEdit:false})} onHide={()=>this.setState({schedEdit:false})}/>
                            }
                        </div>
                        : this.state.upload ?
                        <div className="Loader">
                        ...
                        <div className="MediaUpldMainWrp">
                          ...
                          <input type="file" accept={this.uploadFileExt} style={{display:"none"}} ref="fileUploader" onChange={(e)=>{this.setState({fileUplaodLoding:true}); this.onFileChange(e)}} multiple></input>
                          <img src={require("../../../Assets/Images/Media/select-files.png")} className="MeadiaUpldSlFl" onClick={()=>this.refs.fileUploader.click()}></img>
                          <ReactTable
                          ...
                          />
                           <div className="MediaFlUpldBtm">
                                  <img src={require("../../../Assets/Images/Media/upload-btn-popup.png")}  className="MediaFlupBtn" onClick={()=>this.uploadMultiFiles()}></img>
                                  <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="MediaFlupBtn" onClick={()=>this.setState({fileUplaodLoding:false,upload:false,uplddata:[],selectedFiles:[],upLoadvalidMsg:false})}></img>
                              </div>
                            {
                                this.state.upLoadvalidMsg ==true ?
                                <Dialog title={this.state.dlgtitle} message={this.state.message}
                                        onOk={()=>this.setState({upLoadvalidMsg:false})} onHide={()=>this.setState({upLoadvalidMsg:false})}/>
                                :<div></div>
                          ...
                          <div className="SchedBnrWrp4">
                              ...
                              <div className="SchedgrpSelWrp">
                                <ReactTable
                                  ...
                                  getTrGroupProps={(state, rowInfo, column, instance) => {
                                    if(rowInfo !== undefined){
                                     return {
                                       onClick: (e, handleOriginal) =>{this.setGrpIndex(rowInfo.index,"grp1Index")},
                                       style:{
                                ...
                                <div className="SchedgrpSelBtnWrp">
                                   <div className="SchedSleGrpbtn" onClick={()=>this.setGroupSelection("add")}>{'>'}</div>
                                  <div className="SchedSleGrpbtn" onClick={()=>this.setGroupSelection("remove")}>{"<"}</div>
                                </div>
                                  <div className="ReactTable" style={{"height":"350px","margin":"10px","width":"150px"}}>
                                      <div className="rt-table" role="grid">
                                          <div className="rt-thead -header" style={{"min-width":"100px"}}>
                                              <div className="rt-tr" role="row">
                                                  <div className="rt-th rt-resizable-header" role="columnheader"
                                                       tabindex="-1" style={{"flex": "100 0 auto", "width": "100px"}}>
                                                      <div className="rt-resizable-header-content">Selected Group Names
                                                      </div>
                                                      ...
                                                      <div>
                                                          {
                                                              this.state.grp2Data.map((key, index) =>{
                                                                  return (
                                                                      <div className={this.state.grpSelecteIndex==index?"rt-tr-group rowgroupSelected":"rt-tr-group"} onClick={()=>{this.setState({grpSelecteIndex:index})}} role="rowgroup">
                              ...
                              <div className="MediaFlUpldBtm">
                                    ...
                                    <img src={require("../../../Assets/Images/Login/ok-btn.png")} className="ShedGrnextBtn" onClick={()=>this.checkSelectedGroupLength()}></img>
                                    <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="ShedGrnextBtn" onClick={()=>this.resetFlDetails()}></img>
                                 </div>
                        ...
                        <div className="Loader">
                            <div className="SystemAddRelWrp">
                                ...
                                <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                    ...
                                    <input className="grpName innershadow" value={this.state.grpObj.groupName}
                                ...
                                <div>
                                    ...
                                    <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                        <span className="SystemFlUpldtxt" style={{marginLeft: "6%", width : '25%'}}>End Date *</span>
                                               ...
                                               : this.state.grpEditInfo ?
                                                   <div className="Loader">
                                                       <div className="SystemAddRelWrp">
                                                           ...
                                                           <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                                               <span className="SystemFlUpldtxt" style={{marginLeft: "6%", width : '25%'}}>Group Name *</span>
                                                               <input className="grpName innershadow" value={this.state.groupEditData.Group_ADS_Name}
                                                                      onChange={(e) => this.handleEditValues(e.target.value, 'Group_ADS_Name')}></input>
                                                           </div>
                                                           <div>
                                                               <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                                                   <span className="SystemFlUpldtxt" style={{marginLeft: "6%", width : '25%'}}>Start Date *</span>
                                                                   <DatePicker selected={new Date(this.state.groupEditData.StartDate)}
                                                               ...
                                                               <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                                                   <span className="SystemFlUpldtxt" style={{marginLeft: "6%", width : '25%'}}>End Date *</span>
                                                                   <DatePicker selected={new Date(this.state.groupEditData.EndDate)}
                                                               ...
                                                               <div style={{display: "flex", alignItems: "center", marginTop: "6px", width : '100%'}}>
                                                                   <span className="SystemFlUpldtxt" style={{marginLeft: "6%", width : '25%'}}>Unit Type *</span>
                                                                   <select className="unitDropDown" value={this.state.groupEditData.UnitType}
                                                           ...
                                                           <div className="SystFlUpldBtm">
                                                               ...
                                                               <img src={require("../../../Assets/Images/Login/cancel-btn.png")}
                                                                    className="SystFlnextBtn" onClick={() => this.setState({grpEditInfo: false, groupEditData :{}})}></img>
                                                           </div>
                     ...
                     <div className="Loader">
                       <div className="SchedBtmDtPopWrp">
                          ...
                          <div className="SchedBnrPopImgWrp2">
                              ...
                              <div className="RightDiv-md2">
                                  <input  className="SchedBnrPopinpt" style={{width: '55%'}} type="number" min="0" value={this.state.order} onChange={(e)=>this.setState({order:e.target.value})}></input>
                              </div>
                              <div className="leftDiv-md2">
                              </div>
                              <div className="RightDiv-md2">
                           ...
                           <div className="SchedBnrPopImgWrp2" style={{marginTop:"10px"}}>
                               <div className="leftDiv-md2">
                                   <span className="SchedBnrPopTxt" style={{marginLeft:"-10%"}}>Date Start *</span>
                               </div>
                               <div className="RightDiv-md2">
                                   <DatePicker style={{width: '95%'}} selected={this.state.dateStart} onChange={(date)=>this.setState({dateStart:date})} wrapperClassName="" className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                               </div>
                               <div className="leftDiv-md2">
                                   <span className="SchedBnrPopTxt" style={{marginLeft:"6%"}}>Date End *</span>
                               </div>
                               <div className="RightDiv-md2">
                                   <DatePicker style={{width: '95%'}} selected={this.state.dateEnd} onChange={(date)=>this.setState({dateEnd:date})} wrapperClassName="" className="SchedDatePickInptWrp" popperPlacement="right-start"></DatePicker>
                               </div>
                           </div>
                              ...
                              <div className="SchedBnrPopImgWrp2" style={{marginTop:"13px"}}>
                                  ...
                                  <div className="RightDiv-md2">
                                      <input className="SchedBnrPopinpt1" style={{width: '37%'}} type="number" min="0" value={this.state.timeSrthr} onChange={(e)=>this.setState({timeSrthr:e.target.value})}></input>
                                      <input className="SchedBnrPopinpt1" style={{width: '37%'}} type="number" min="0" value={this.state.timeSrtmin} onChange={(e)=>this.setState({timeSrtmin:e.target.value})}></input>
                                  </div>
                                  <div className="leftDiv-md2">
                                      <span className="SchedBnrPopTxt" style={{marginLeft:"2%"}}>Time End *</span>
                                  </div>
                                  <div className="RightDiv-md2">
                                      <input className="SchedBnrPopinpt1" style={{width: '37%'}} type="number" min="0" value={this.state.timeEndhr} onChange={(e)=>this.setState({timeEndhr:e.target.value})}></input>
                                      <input className="SchedBnrPopinpt1" style={{width: '37%'}} type="number" min="0" value={this.state.timeEndmin} onChange={(e)=>this.setState({timeEndmin:e.target.value})}></input>
                                  </div>
                          ...
                          <div className="SchedBnrPopImgWrp2">
                              ...
                              <div className="RightDiv-md2">
                                  <input className="SchedBnrPopinpt" style={{width: '55%'}} type="number" onChange={(e)=>this.setState({fLength:e.target.value})} value={this.state.fLength==""?this.state.flEditData.Len:this.state.fLength} min="0"></input>
                              </div>
                              <div className="leftDiv-md2">
                              </div>
                              <div className="RightDiv-md2">
                          ...
                          <div className="SchedBnrPopImgWrp2">
                              ...
                              <div className="RightDiv-md2">
                                  <select className="SchedDropDwn1" onChange={(e)=>this.setState({fScreen:e.target.value})} value={this.state.fScreen}>
                                      <option value={1}>True</option>
                                      <option value={0}>false</option>
                                  </select>
                              </div>
                          ...
                          <div className="SystFlUpldBtm">
                                    ...
                                    <img src={require("../../../Assets/Images/Login/cancel-btn.png")}
                                         className="SystFlnextBtn" onClick={() => this.setState({btmDetails: false,order:1,dateStart:new Date(),dateEnd:new Date(),timeEndhr:0,timeEndmin:0,timeSrthr:0,timeSrtmin:0,fScreen:0,fLength:0})}></img>
                          </div>
                       </div>
                     </div>
                     ...
                     <div className="Loader">
                     <div className="SchedBnrWrp4">
                         <div className="ForgPassTitle">Media Scheduling</div>
                         <div className="SchedgrpSelWrp">
                           <ReactTable
                             columns={grpCol1}
                             data={this.state.grp1Data}
                         ...
                         <div className="MediaFlUpldBtm">
                               <img src={require("../../../Assets/Images/Login/ok-btn.png")} className="SystFlnextBtn" onClick={()=>this.associateGroupsTofile()}></img>
                               <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="SystFlnextBtn" onClick={()=>this.setState({btmGrpAssociated:false,grp1Index:[],grp2Index:[],grp2Data:[]},()=>this.getRecords("GroupADSFLFiles/Fetch"))}></img>
                            </div>
                     </div>
                   </div>
                    ...
                    <div className="Loader">
                        <div className="SchedBnrWrp5">
                            <div className="ForgPassTitle">Associate Ratecodes</div>
                            <ReactTable
                        ...
                        <div className="SchedEdtFileTopWrp">
                                  <div className="SchedEdtFileTopChild1" onClick={()=>this.loadFiles(3,"Vbanner","Bsched")}>
                                      <span className="SchedBnrPopImgTypetxt">Vertical Banner</span>
                                      {
                                          this.state.houseObj && this.state.houseObj.WebVisibleURLVBanner?
                                              <div>
                                                  <div className="SchedBnrpopImgWrp">
                                                      <img src={this.state.houseObj.WebVisibleURLVBanner} className="SchedBnrpopImg_V"></img>
                                                      <div className="SchedBnrpopImgOvrWrp">
                                ...
                                <div className="SchedEdtFileTopChild1" onClick={()=>this.loadFiles(2,"Hbanner","Bsched")}>
                                  <span className="SchedBnrPopImgTypetxt">Horizontal Banner</span>
                                  {
                                      ...
                                      <div>
                                          <div className="SchedBnrpopImgWrp">
                                           <img src={this.state.houseObj.WebVisibleURLHBanner} className="SchedBnrpopImg_H"></img>
                                           <div className="SchedBnrpopImgOvrWrp">
                            ...
                            <div className="ScheduleTabToolWrp">
                                <div className="ScheduleTableToolCont">
                                   {/* <img src={require('../../../Assets/Images/tools/filter-ico.png')} className="ScheduleToolImg"></img>*/}
                                    ...
                                    <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img> */}
                                    <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getRecords("GroupADSFLFiles/Fetch")}></img>
                                </div>
                            </div>
                            <ReactTable
             ...
             <div className={"SchedGrpFilVWrp"}>
               ...
               <div className="ScheduleTabToolWrp">
                   <img src={require('../../../Assets/Images/Upload/upload-btn.png')} className="ScheduleupldImg" onClick={()=>this.setState({upload:true})}></img>
                   <div>
                   <img src={require('../../../Assets/Images/Upload/schedule-btn.png')} className="ScheduleupldImg1"
                        onClick={()=>this.setState({schedFile:!this.state.schedFile,isenableschedBtn:true})}></img>



                   <div className={this.state.schedFile?"Schedd_nav":"Schedd_nav1"}>
                      <div className="Schednav__submenu-item" onClick={()=>this.setState({schedFile:false,schedVideo:true})}>Video</div>
                      <div className="Schednav__submenu-item"  onClick={()=>this.setState({schedFile:false,schedBanner:true})}>Banner</div>
                    </div>
                   </div>
                   <div className="ScheduleTableToolCont">
                       <img src={require('../../../Assets/Images/tools/change-perspective.png')} className="ScheduleToolImg" onClick={()=>this.setGroup(true)}></img>
                       <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                      {/* <img src={require('../../../Assets/Images/tools/filter-ico.png')} className="ScheduleToolImg"></img>*/}
                       <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                       <img src={require('../../../Assets/Images/tools/show-coloumn.png')} className="ScheduleToolImg" onClick={()=>this.setState({columnSt:!this.state.columnSt})}></img>
                       <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                       <ExportCSV csvData={this.state.data} fileName={this.state.exportFileName} visibleCol={this.state.columns} isConversion={true} callback={()=>this.getRecords("GroupADSFLFiles/Fetch")} />
                       <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                       <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getRecords("GroupADSFLFiles/Fetch")}></img>
                   </div>
                  </div>
                ...
                <ReactTable
                    ...
                    getTrGroupProps={(state, rowInfo, column, instance) => {
                     if(rowInfo !== undefined){
                      return {
                        onClick: (e, handleOriginal) =>{this.setState({FlDtIndex:rowInfo.index},()=>console.log("MainData",rowInfo.original))},
                        onDoubleClick:()=>{
                            console.log("data on double click",rowInfo.original);
                            ...
                            this.setState({flEditData:rowInfo.original,editFile:true,typeL:rowInfo.original.IndexType,fLength:rowInfo.original.Len});
                            this.state.flEditData.Len =rowInfo.original.Len;
                            this.state.flEditData.IndexType = rowInfo.original.IndexType;
                        },
                        style:{
                 ...
                 <div className="SchedFilVwbtmTogWrp" onClick={()=>this.setFlDetails(0,true,true)}>
                   <img src={require('../../../Assets/Images/Media/right-arrow.png')} className={this.state.schedBtm?"SchedBtmArrowImg2":"SchedBtmArrowImg"}></img>
                 </div>
                     {
                   ...
                   <div className="CabDtTabMainWrp">
                     {
                       subTabs && subTabs.map((key,index)=>(
                           <div className={this.state.FlDtTabIndex === index ?"CabDtTabWrp1":"CabDtTabWrp"} onClick={()=>this.setFlDetails(index,true,false)}>{key}</div>
                       ))
                     }
                     </div>
                   <ReactTable
                       ...
                       getTrGroupProps={(state, rowInfo, column, instance) => {
                        if(rowInfo !== undefined){
                         return {
                           onDoubleClick:()=>{this.setBtmDetails(rowInfo.original)},                     }
                        }else{
                            return {
                                onDoubleClick:()=>{this.setBtmDetails(null,1)},                     }
                        }
                       }}
                       getTheadFilterProps={(state, rowInfo, column, instance) => {
                         return {
              ...
              </div>
               {
                 ...
                 <div className="SchedGrpWrp">
                    ...
                    <img src={require("../../../Assets/Images/Group/add-over.png")} className="SchedGrpTableToolImg" onClick={() => this.addGroup()}></img>
                 <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr" ></img>
                 <img src={require("../../../Assets/Images/Group/delete-over.png")} className="SchedGrpTableToolImg" onClick={()=>this.handeldeleteBeforedelete()}></img>
                      <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                      <div>
                       <img src={require("../../../Assets/Images/Group/change-status.png")} className="SchedGrpTableToolImg" onClick={()=>this.openStatusDll()}></img>
                      ...
                      <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                      <img src={require("../../../Assets/Images/Group/house_icon_20px.gif")} className="SchedGrpTableToolImg" onClick={()=>this.setState({houseAd:true})}></img>
                      <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                      <img src={require("../../../Assets/Images/Group/preview.gif")} className="SchedGrpTableToolImg" onClick={()=>this.setPrevColumns()}></img>
                      <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                      <img src={require("../../../Assets/Images/tools/refresh.png")} className="SchedGrpTableToolImg" onClick={()=>this.getGrpData("GroupADSFL/Fetch","get")}></img>
                      <img src={require("../../../Assets/Images/Media/collapse-view.png")} className="SchedGrpTableToolImg2" onClick={()=>{this.setState({grpFileView:false});this.getGrpData("GroupADSFL/Fetch",'get')}}></img>
                    </div>
                    <ReactTable
                                ...
                                getTrGroupProps={(state, rowInfo, column, instance) => {
                                  if(rowInfo !== undefined){
                                    return {
                                      onMouseOver: (e, handleOriginal) =>{this.setGroupInf(rowInfo)},
                                      onClick: (e, handleOriginal) =>{this.setState({FlDtIndex:rowInfo.index,grpId:rowInfo.original.Group_ADS_ID})},
                                      onDoubleClick:()=>{this.setEditGroupData(rowInfo)},
                                      /*style:{
                  ...
                  <div className="SchedGrpInfoChild1">
                      <div className="SchedGrpInfoChild2">Videos:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]? this.state.grpData[this.state.grpIndex].VideoCount:0}</div>
                    <div className="SchedGrpInfoChild2">Buttons:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]?this.state.grpData[this.state.grpIndex].ButtonCount:0}</div>
                    <div className="SchedGrpInfoChild2">Banners:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]?this.state.grpData[this.state.grpIndex].BannerCount:0}</div>
                  </div>
                  <div className="SchedGrpInfoChild1">
                  <div className="SchedGrpInfoChild2">Associated Cabs:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]?this.state.grpData[this.state.grpIndex].CabCount:0}</div>
                    <div className="SchedGrpInfoChild2">Restricted Cabs:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]?this.state.grpData[this.state.grpIndex].RestrictedCabCount:0}</div>
                  </div>
                      </div>
                  </div>
                  :
                  <div className="SchedFileVTogWrp" onClick={()=>this.setState({grpFileView:true})}>
            ...
            <div id="container" contextMenu="none" onContextMenu={(e)=> e.preventDefault()}>
                             ...
                             this.state.rightAction > 0 ?
                                 <div className="actionMenu" style={{top:`${this.state.y}px`,left:`${this.state.x}px`}}>
                                     <ul className="actionUl" style={{"list-style":"none"}}>
                                         <li>
                                             <div onClick={()=>this.setContextMenu("Geozone")}>Update Geozones</div>
                                             <div onClick={()=>this.setContextMenu("Ratecode")}>Update Rate Codes</div>
                                             <div onClick={()=>this.setContextMenu("Pickup")}>Update Pickup Geozones</div>
                                         </li>
                                     </ul>
                                 </div>:<div></div>
                ...
                <div className="CabDtTabMainWrp">
                        {
                                this.tabs && this.tabs.map((key,index)=>(
                                  <div className={this.state.tabIndex === index ?"CabDtTabWrp1":"CabDtTabWrp"} onClick={()=>this.setState({tabIndex:index},()=>this.setGroup(true))}>{key} ( {this.getTabDataCount(key)} )</div>
                                ))
                        }
                  </div>
                <div className="ScheduleTabToolWrp">
                     <img src={require('../../../Assets/Images/Upload/upload-btn.png')} className="grShedImg" onClick={()=>this.setState({upload:true})}></img>
                     {
                       this.state.tabIndex === 0 ?
                       <div style={{display:"flex"}}>
                          <img src={require('../../../Assets/Images/Schedule/add-video.png')} className="grShedImg" onClick={()=>this.setState({schedVideo:true,isenableschedBtn:true})}></img>
                          <img src={require('../../../Assets/Images/Schedule/delete-video.png')} className="grShedImg" onClick={()=>this.beforeDeletefiles(0)}></img>
                          <img src={require('../../../Assets/Images/Schedule/copy-video.png')} className="grShedImg" onClick={()=>this.copyVideo(0)}></img>
                      </div>
                      :
                      <div style={{display:"flex"}}>
                          <img src={require('../../../Assets/Images/Schedule/add-banner.png')} className="grShedImg" onClick={()=>this.setState({schedBanner:true})}></img>
                          <img src={require('../../../Assets/Images/Schedule/delete-banner.png')} className="grShedImg" onClick={()=>this.beforeDeletefiles(1)}></img>
                          <img src={require('../../../Assets/Images/Schedule/copy-banner.png')} className="grShedImg" onClick={()=>this.copyVideo(1)}></img>
                      </div>
                     }
                      <div className="ScheduleTableToolCont">
                          <img src={require('../../../Assets/Images/tools/change-perspective.png')} className="ScheduleToolImg" onClick={()=>this.setGroup(false)}></img>
                          <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                          {/*<img src={require('../../../Assets/Images/tools/filter-ico.png')} className="ScheduleToolImg"></img>*/}
                          <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                          <img src={require('../../../Assets/Images/tools/show-coloumn.png')} className="ScheduleToolImg" onClick={()=>this.setState({columnSt:!this.state.columnSt})}></img>
                          <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                          <ExportCSV csvData={this.state.data} fileName={this.state.exportFileName} visibleCol={this.state.switchcolumns} isConversion={true} callback={()=>this.getRecords("GroupADSFLFiles/Fetch")} />
                          <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                          <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getRecords("GroupADSFLFiles/Fetch")}></img>
                      </div>
                  </div>
                    <ReactTable
                        ...
                        getTrGroupProps={(state, rowInfo, column, instance) => {
                          if(rowInfo !== undefined){
                           return {
                            onContextMenu: (e) => {
                                this.setState({selectedRow: rowInfo,rightAction:1, x: e.screenX, y: e.screenY-50,visibleFilters:[],flEditData:rowInfo.original,FlDtIndex:rowInfo.index});


                            },
                             onClick: (e, handleOriginal) =>{this.setState({FlDtIndex:rowInfo.index})},
                             onDoubleClick:()=>{
                                 ...
                                 this.setState({timeSrthr:timeSrthr,timeSrtmin:timeSrtmin,timeEndhr:timeEndhr,timeEndmin:timeEndmin});
                                 this.setState({flEditData:data,editFile:true,editGrFile:true,typeL:rowInfo.original.IndexType,provider:provider,fScreen:rowInfo.original.FULLSCR_NG});
                             },
                             style:{
                               background:rowInfo.original.ColorStatus > 0 ? rowColor[rowInfo.original.ColorStatus]:"",
                             }
             ...
             </div>
             {
               ...
               <div className="SchedGrpTableToolWrp">
                 ...
                 <img src={require("../../../Assets/Images/Group/preview.gif")} className="SchedGrpTableToolImg" onClick={()=>this.setPrevColumns()}></img>
                 <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                 <img src={require("../../../Assets/Images/tools/refresh.png")} className="SchedGrpTableToolImg" onClick={()=>{this.setState({grpData:[]});this.getGrpData("GroupADSFL/Fetch","get")}}></img>
                 <img src={require("../../../Assets/Images/Media/collapse-view.png")} className="SchedGrpTableToolImg2" onClick={()=>{this.setState({collapse:false});this.getGrpData("GroupADSFL/Fetch",'get')}}></img>
               </div>
               <ReactTable
                            ...
                            if(rowInfo !== undefined){
                              ...
                              return {
                                ...
                                onClick:(e, handleOriginal)=>{
                                    ...
                                    this.setState({grpId:rowInfo.original.Group_ADS_ID},()=>{
                                  if(this.state.group){
                                    this.getRecords();
                                  }
                                })},
                  ...
                  <div className="SchedGrpInfoChild2">Associated Cabs:{this.state.grpData.length && this.state.grpData[this.state.grpIndex]?this.state.grpData[this.state.grpIndex].CabCount:0}</div>
                ...
                </div>
                   {
                       this.state.grViewGroupValid ?
                           <Dialog title={this.state.dlgtitle} message={this.state.message} onOk={()=>this.setState({grViewGroupValid:false})} onHide={()=>this.setState({grViewGroupValid:false})}/>
                           :<div></div>

                   }
             </div>
             :
             <div className="SchedFileVTogWrp" onClick={()=>this.setState({collapse:true})}>
               <img src={require('../../../Assets/Images/Media/right-arrow.png')} className="SchedBtmArrowImg1"></img>
           </div>
             }
