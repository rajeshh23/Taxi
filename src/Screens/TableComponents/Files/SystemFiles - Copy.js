...
const subTabsUrl=["","ScheduleRelease/FetchReleaseAssociatedCabs/","Phase/FetchAssociatedReport/"];
  ...
  grpColumn=[
    {
      ...
      Cell: rowInfo => <div className="SystFlColContainer">
        ...
        <img src={require("../../../Assets/Images/Group/file.png")} className="StatGrpFileImg1" onClick={()=>this.scheduleRelease("Report",rowInfo.original.ID)}></img>
        <img src={require("../../../Assets/Images/System/run.png")} className="SystTableToolImg" onClick={()=>this.scheduleRelease("Schedule",rowInfo.original.ID)}></img>
        <img src={require("../../../Assets/Images/Group/add-over.png")} className="SystTableToolImg2" onClick={()=>this.openAddPhasePopUp("Add Phase")}></img>
        </div>
  ...
  subColumn=[
    {
      ...
      Cell: rowInfo => <div className="SystFlColContainer">
        <span className='number'>{rowInfo.original.Name}</span>
        {
          ...
          <div className="SystGrpRowImgWrp">
          <img src={require("../../../Assets/Images/System/active.PNG")} className="StatGrpFileImg1"></img>
          </div>
          :
           <div className="SystGrpRowImgWrp">
          <img src={require("../../../Assets/Images/System/inActive.PNG")} className="StatGrpFileImg1"></img>
          <img src={require("../../../Assets/Images/Group/delete-over.png")} className="StatGrpFileImg1" onClick={()=>this.deletePhase(rowInfo.original)}></img>
          </div>
  ...
  crtColumn=[
    {
      ...
      show:true,
      Cell: (rowInfo) => <ComCheck  onChange={(e)=>this.selectCriteria(rowInfo.original)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>,
      width:25
  ...
  crtColumn1=[
    {
      ...
      show:true,
      Cell: (rowInfo) => <ComCheck  onChange={(e)=>this.selectCriteria1(e,rowInfo.original)} checked={this.state.selectedCriteriaArr.findIndex(x=>x.ID===rowInfo.original.ID)>=0?true:false}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>,
      width:25
  ...
  marketid;
     ...
     console.log("ok",this.state.selectedCriteriaArr);
        ...
        this.state.cabId=[];
          if(index === 0 && tabColumns && tabColumns[index]){
           ...
           let obj = {
            Header: "#",
            Cell: (rowInfo) => <ComCheck  onChange={(e)=>this.setDelete(rowInfo.original.FileID)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>, // Custom cell components!
            width:25
          }
          dColumn.push(obj);
           tabColumns[index].map((key,index)=>{
                ...
                }else if(key.accessor === "FileName" || key.accessor === "ReadMeFileName"){
                  obj={
                    Header: (cellInfo)=><div><div className="ScheduleHeaderWrp">
                    <div>{key.lable}</div>
                    {
                    ...
                    //   }
                    //   </div>,
                    Cell:(props)=><div className="SystFlColContainer">
                      <span className="SystFlColTxt">{props.value}</span>
                        {
                            key.accessor === "FileName" &&
                            <img style={{width:"20px",height:"15px"}} src={require("../../../Assets/Images/Media/download.jpg")} className="SystFlColDnldImg" onClick={()=>this.downloadfile(props.value)}></img>
                        }
           ...
           this.setState({columns:dColumn,tabIndex:index},()=>{
            ...
            if(this.state.releaseData && this.state.releaseData.length > 0){
              this.setState({tabIndex:index,loading:true},()=>this.setSubTab(this.state.subTabIndex))
            }else{
              this.setState({tabIndex:index,loading:true},()=>this.getReleaseData())
         ...
         downloadfile(fileName){
            ...
            window.open(sessionStorage.getItem("mktUrl")+"api/"+"DownloadFiles/GetFile/"+ext)
         }
         getStaustString(val){
    ...
    handleClickOutside(event) {
        ...
        scheduleRelease(type,id){
          ...
          .then((res)=>{
            if(res && res.data && res.data.ReturnCode === 0){
              ...
              this.setState({dlgtitle:"Information",message:"Something went wrong",dlgType:"information",dlgEnable:true})
            }
          })
        }
        ...
        setScheduleCol(){
            ...
            this.state.visibleFilters=[];
            let obj = {
                Header: <div></div> /*()=><ComCheck onChange={(e)=>this.getAllunitIds()}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>*/,
                Cell: (rowInfo) => <ComCheck checked={this.state.cabId.indexOf(rowInfo.original.UNITID) >=0} onChange={(e)=>this.setCab(rowInfo.original.UNITID,e)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"} ></ComCheck>, // Custom cell components!
                width:25,
                resizable:false
            }
            dColumn.push(obj)
         ...
         setSubTab(index){
          ...
          if(index === 1){
            let obj = {
              Header: "#",
              Cell: (rowInfo) => <ComCheck  onChange={(e)=>this.setCab(rowInfo.original.UNITID,e)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>, // Custom cell components!
              width:25
            }
            dColumn.push(obj)
          }
          if(index > 0){
                        subTabColumns[index].map((key,index)=>{
                          ...
                          obj={
                            ...
                            obj={
                              ...
                              //     }
                              //     </div>,
                              Cell: rowInfo => <span className='number'>{UnitMode[rowInfo.original.UnitMode]}</span> // Custom cell components!
                          }
                          }else{
                              if(key.accessor=="status"){
                                  obj={
                                      ...
                                      <div style={{position:"absolute",zIndex:12,marginTop:"12px"}}>{
                                          this.state.visibleFilters.indexOf(cellInfo.column.id) >= 0 &&
                                          <Search onChange={(e)=>this.customStatusFilerChange(e.target.value,cellInfo.column.id,index)} value={this.state.filterVal[index]}></Search>
                                        }
                                        </div>
                                      </div>,
                                      accessor:key.accessor,
                                      ...
                                      //     }
                                      //     </div>,
                                      Cell: rowInfo => <span className='number'>{rowInfo.original && this.getStaustString(rowInfo.original.status)}</span> // Custom cell components!
                                  }
                              }
                              else{
                                  obj={
                                      ...
                                      <div>{key.lable}</div>
                                          <div style={{display:"flex",marginLeft:"auto"}}>
                                             <img src={require('../../../Assets/Images/Cab/sort.png')} className="ScheduleheadFilt1" onClick={()=>{
                    ...
                    dColumn.push(obj1);
                    this.setState({columns:dColumn,subTabIndex:index,dataObj:this.dataObj},()=>{
                      if(this.state.subTabIndex === 1){
                        if(this.state.releaseData && this.state.releaseData.length > 0){
                            var dataindex = 0;
            ...
            let sColumn=[];
             this.state.filterVal=[];
               ...
               this.setState({vColumn:dColumn,crColumn:sColumn,subTabIndex:index,dataObj:this.dataObj})
         ...
         customFilerChange(value,accessor,index,column){
           let filtered = this.state.filtered;
            ...
            if(this.state.addCab){
              ...
              this.timer = setTimeout(()=>  this.getAvailavleCabsListForAssociation(newFilter),500)
            }else if(this.state.isSysfileSchedule){
                clearTimeout(this.myTimer)
              this.myTimer = setTimeout(()=>this.getCabsListForscheduleFile(newFilter),400)
          ...
          let filtered = this.state.filtered;
           ...
           if (insertNewFilter) {
            ...
            if(value !== "" &&  "scheduled".includes(value.toLowerCase())){
              val = "0";
             }else if(value !== "" && "yet to be scheduled".includes(value.toLowerCase())){
              val = "2";
             }else if(value !== "" && "upgrade successfull".includes(value.toLowerCase())){
              val = "1";
             }
         ...
         getRecords(url){
           this.setState({loading:true,rightAction:0,isSysfileSchedule:false,cabId:[]})
          ...
          .then((res)=>{
            if(res && res.data && res.data.ResponseCollection){
              this.setState({data:[]})
                ...
                this.setState({data:res.data.ResponseCollection,loading:false,deleteFiles:[]})
      ...
      if(value === "confirm"){
        if(this.state.deleteFiles && this.state.deleteFiles.length > 0){
          this.setState({dlgtitle:"Confirmation",message:"Are you sure?",dlgType:"confirmation",dlgEnable:true})
            ...
            this.setState({dlgtitle:"Information",message:"Please Select Files",dlgType:"Information",dlgEnable:true})
        }
      }else{
        if(this.state.deleteFiles && this.state.deleteFiles.length > 0){
          ...
          postData("SystemFile/DeleteSystemFile",obj)
          .then((res)=>{
            if(res.data && res.data.ReturnCode === 0){
                if(res.data.StatusResponseCollection && res.data.StatusResponseCollection.length>0){
                    if(res.data.StatusResponseCollection[0]==4){
                        ...
                        this.setState({dlgtitle:"Information",message:"File(s) are currently used in Release Management so cannot be deleted...",dlgType:"Information",dlgEnable:true,deleteFiles:[]})
                    }else{
                        this.setState({dlgtitle:"Information",message:"Deleted Successfully",dlgType:"Information",dlgEnable:true,deleteFiles:[]})
                    }
                }else{
                    this.setState({dlgtitle:"Information",message:"Deleted Successfully",dlgType:"Information",dlgEnable:true,deleteFiles:[]})
                }
        ...
        .then(res=>{
            ...
            if(res.data && res.data.ReturnCode===0){
                    ...
                    this.setState({systProgCnt:100},()=>{
                        this.setState({relUpload:false,systProg:false,disbleRelease:false})
                    })
                ...
                this.setState({dlgtitle:"Information",message:"File with same name alrady exists",dlgType:"information",dlgEnable:true,upload:false,uplddata:[],selectedFiles:[],systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0})
            }
            else{
              this.setState({dlgtitle:"Information",message:"Faild please try upload again",dlgType:"information",dlgEnable:true,upload:false,uplddata:[],selectedFiles:[],systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0})
            }
        })
      }else{
    ...
    openAddReleasePopUp(type,index){
        ...
        console.log(date);
        var endDate = date
        this.setState({addType:type,addFile:true,strDate:strDate,strEndDate:endDate});
    }
    openAddPhasePopUp(type,index){
        var strDate = new Date();
        this.setState({addType:type,addFile:true,strDate:strDate,status:0})
    }
    deletePhase(Data){
            ...
            getData(url)
                .then((res)=>{
                    if(res.data.ReturnCode === 0){
                        this.setState({addFile:false,dlgtitle:"Information",message:msg,dlgType:"information",dlgEnable:true,systName:"",relName:""})
                    }
                })
        }
    ...
    setRelease(type, index) {
        ...
        if (this.doubleClick === false) {
            ...
            if (type === "Edit Release") {
                ...
                let data = this.state.releaseData[this.state.fileIndex].childrens[index]
    ...
    uploadRelease(){
      console.log("call upload release",this.state.selectedReleaseData);
        ...
        if (this.state.addType === "Add Phase") {
            ...
            obj = {
                "AssociateCabCount": this.state.releaseData[this.state.fileIndex].AssociateCabCount,
                "EndTime": null,
        ...
        if(isvalied==""){
            ...
            postData(url,obj)
                .then((res)=>{
                    if(res.data.ReturnCode === 0){
                        this.setState({addFile:false,dlgtitle:"Information",message:msg,dlgType:"information",dlgEnable:true,loading:true,systName:"",relName:""},()=>this.getReleaseData())
                    }else if(res.data.ReturnCode === 4){
                        this.setState({addFile:false,dlgtitle:"Information",message:"release with same name alrady exist",dlgType:"information",dlgEnable:true,loading:true,systName:"",relName:""},()=>this.getReleaseData())
                    }
                })
        }else{
            this.setState({
   ...
   refreshReportData(){
        ...
        if(this.state.phaseSelected==true){
            getData("/Phase/FetchAssociatedReport/"+this.state.releaseData[this.state.fileIndex].childrens[this.state.phaseIndex].ID+"/-1")
                .then((res)=>{
                    this.rowClick =false;
                    if(res && res.data && res.data.ResponseCollection){
            ...
            getData("/Phase/FetchAssociatedReport/-1/"+this.state.releaseData[this.state.fileIndex].ID)
                .then((res)=>{
                    this.rowClick =false;
                    if(res && res.data && res.data.ResponseCollection){
                        this.setState({data:res.data.ResponseCollection,loading:false})
      ...
      if(this.rowClick === false){
        ...
        if(this.state.subTabIndex === 1){
          if(type === "release"){
              ...
              this.setState({cabUrl:"ScheduleRelease/FetchReleaseAssociatedCabs"},()=>this.refReactTable.fireFetchData())
          }else if(type === "phase"){
              this.state.phaseSelected =true;
              this.cabObj={
                "pPhaseID":this.state.releaseData[this.state.fileIndex].childrens[this.state.phaseIndex].ID,
                "unitlistCriteria": this.state.dataObj
            }
              this.setState({cabUrl:"Phase/FetchAssociatedCabs"},()=>this.refReactTable.fireFetchData())
          }
        }else if(this.state.subTabIndex === 2){
          if(type === "release"){
              this.state.phaseSelected =false;
              getData("/Phase/FetchAssociatedReport/-1/"+this.state.releaseData[index].ID)
            .then((res)=>{
              this.rowClick =false;
              if(res && res.data && res.data.ResponseCollection){
                this.setState({data:res.data.ResponseCollection,loading:false})
              ...
              this.state.phaseSelected =true;
            getData("/Phase/FetchAssociatedReport/"+this.state.releaseData[this.state.fileIndex].childrens[index].ID+"/-1")
            .then((res)=>{
              this.rowClick =false;
              if(res && res.data && res.data.ResponseCollection){
                this.setState({data:res.data.ResponseCollection,loading:false})
    ...
    fetchComponent(){
        getData("SystemFile/FetchComponent")
            .then(res=>{
                if(res.data && res.data.ReturnCode === 0){
                    if(res.data.ResponseCollection && res.data.ResponseCollection.length>0){
    ...
    addSystemFile(){
      if(this.state.isSysFileForEdit && this.state.selectedRowData){
        if(this.state.uType && this.state.uType.length === 0){
          ...
          let obj ={
            "arrSystemFileSuccessVO":this.state.selectedRowData.arrSystemFileSuccessVO,
        ...
        postData("SystemFile/EditSystemFile",obj)
            .then(res=>{
                ...
                if(res.data && res.data.ReturnCode === 0){
                    this.getRecords("SystemFile/Fetch")
                    this.setState({upload:false,editSucessCrt:true},()=>this.getCriteria())
          ...
          let component = null;
          if (this.state.Mx925SYSVersionInfo && this.state.Mx925SYSVersionInfo.length > 0) {
              component = this.state.Mx925SYSVersionInfo;
          }
          if (this.state.systFile.length === 0 || this.state.relFile.length === 0) {
              this.setState({
                  dlgtitle: "Information",
                  message: this.state.systFile.length === 0 ? "Please select system file" : "Please select release file",
                  dlgType: "information",
                  uploadVal: true
              })
        ...
        postData("SystemFile/AddSystemFile",obj)
            .then(res=>{
                if(res.data && res.data.ReturnCode === 0){
                    this.successRsp = res.data.ResponseCollection[0];
                    if(res.data.ResponseCollection[0].arrVersionInfoVO){
                        this.state.sysFileVersionData=res.data.ResponseCollection[0].arrVersionInfoVO;
                    }
                    this.setState({upload:false,sucUpld:true},()=>this.getCriteria())
                }
            })
        }
    ...
    postData("SystemFile/EditSystemFile",obj)
    .then(res=>{
      this.setState({sucUpld:false,editSucessCrt:false,systFile:[],relFile:[],desc:"",endDate:new Date(), priority:"",uType:[], systProg:false,systProgCnt:0,relUpload:true,relProg:false,relProgCnt:0,selectedCriteriaArr:[]})
      if(res.data && res.data.ReturnCode === 0){
          console.log("EditSystemFile")
          this.setState({dlgtitle:"Information",message:msg,dlgType:"Information",dlgEnable:true,systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0},()=> this.getRecords("SystemFile/Fetch"))
      }
    })
    ...
    opneeditSysFilePopup(){
        ...
        if(this.state.selectedRowData.arrSystemFileSuccessVO){
          this.state.selectedCriteriaArr=this.state.selectedRowData.arrSystemFileSuccessVO
        }

        this.setState({desc:this.state.selectedRowData.Description,priority:this.state.selectedRowData.PrID,uType:editUnitType,isSysFileForEdit:true,upload:true});
    }
    ...
    scheduleSysFileToCab(){
        ...
        if(this.state.cabId && this.state.cabId.length>0){
            ...
            postData("SystemFile/ScheduleSystemFile",obj)
                .then(res=>{
                    if(res.data && res.data.ReturnCode==0){
                        console.log("successfully");
                        this.setState({dlgtitle:"Information",message:"System Files scheduled to the units successfully...",dlgType:"information",dlgEnable:true,addCab:false,cabId:[],isSysfileSchedule:false})
                    }
                })
        }
    }
            ...
            .then(res => {
                if (res.data && res.data.ResponseCollection) {
                    this.setState({ScheduleCabList:[]},()=>{
                        this.setState({ScheduleCabList: res.data.ResponseCollection,totalCnt:res.data.FilteredCount,filterCnt:res.data.FilteredCount,pageCount:Math.ceil(res.data.TotalcountOfItems/100),schedLoading:false})
    ...
    getnewcall(rowstart,rowend){
        ...
        getData("UnitList/FetchReleaseAssociate/"+this.state.releaseData[this.state.fileIndex].childrens[this.state.phaseIndex].ScheduleReleaseID+"/"+rowstart+"/"+rowend)
            .then(res=>{
                if(res.data && res.data.ResponseCollection){
    ...
    getAssocitedCabs(){
      if(this.state.releaseData[this.state.fileIndex].childrens){
          var obj={
              "SchedulereleaseID":this.state.releaseData[this.state.fileIndex].childrens[this.state.phaseIndex].ScheduleReleaseID,
              "RowStart":1,
              "RowEnd":100,
              "filterCriteria":{
                  "CABNUMBER":null,
          ...
          postData("UnitList/FetchReleaseAssociateWithFilter",obj)
              .then(res=>{
                  if(res.data && res.data.ResponseCollection){
                      this.setState({cabData:res.data.ResponseCollection,cabCount:res.data.TotalcountOfItems})
                  }
              })
    ...
    setAssociatecabsCol(reload,data){
      ...
      let obj = {
          Header: "#",
          Cell: (rowInfo) => <ComCheck   onChange={(e)=>this.setCab(rowInfo.original.UNITID,e)} checked={this.state.cabId.indexOf(rowInfo.original.UNITID)!== -1}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>, // Custom cell components!
          width:25
      }
      dColumn.push(obj)
          ...
          let obj={};
           if(key.accessor=="UnitMode"){
            obj={
              ...
              {
                  this.state.filterVal[index] === ""?
                  <img src={require('../../../Assets/Images/Filter/filter.png')} className="ScheduleheadFilt" onClick={()=>this.setAddCabFilter(cellInfo.column.id,index)}></img>
                  :
                  <img src={require('../../../Assets/Images/Filter/filter_active.png')} className="ScheduleheadFilt" onClick={()=>this.setAddCabFilter(cellInfo.column.id,index)}></img>
              }
              </div>
              <div style={{position:"absolute",zIndex:12,marginTop:"12px"}}>{
                  this.state.addCabVisibleFilters.indexOf(cellInfo.column.id) >= 0 &&
                  <Search onChange={(e)=>this.customFilerChange(e.target.value,cellInfo.column.id,index)} value={this.state.filterVal[index]}></Search>
                }
                </div>
              </div>,
            ...
            obj={
              ...
              //     }
              //     </div>,
              Cell: rowInfo => <span className='number'>{rowInfo.original.Current}</span> // Custom cell components!
            }
          }else{
            obj={
              Header: (cellInfo)=><div><div className="ScheduleHeaderWrp">
    ...
    getAvailavleCabsListForAssociation(newFilter,refresh){
      if(!this.state.addCab){
       ...
       if(this.state.releaseData[this.state.fileIndex].childrens &&((this.state.addCab && newFilter.length > 0)|| (!this.state.addCab && newFilter.length === 0))){
         ...
         this.setState({cabData:[],cabInfoLoading:true})
          ...
          if(refresh === 'refresh'){
           ...
           postData("UnitList/FetchReleaseAssociateWithFilter",obj)
               .then(res=>{
                   if(res.data && res.data.ResponseCollection){
                       ...
                       this.setState({cabCount:res.data.ResponseCollection.length,cabData:res.data.ResponseCollection,totalCnt:res.data.TotalcountOfItems,filterCnt:res.data.FilteredCount,pageCount:Math.ceil(res.data.FilteredCount/100)},()=>{
           ...
           if(refresh === 'refresh'){
               ...
               setTimeout(()=>{this.setState({cabData:temp,cabInfoLoading:false})},500)
           }
   ...
   getAllUnitForSchedule(newFilter,e){
    ...
    if(e === false){
        this.setState({ScheduleCabList:[],cabInfoLoading:true, isAllSelected:false,cabId:[],},()=>{
       ...
       this.setState({ScheduleCabList:[],cabInfoLoading:true})
        if(this.state.releaseData[this.state.fileIndex].childrens){
           ...
           if(newFilter){
            ...
            postData("UnitList/FetchReleaseAssociateUnitIds",obj)
                .then(res=>{
                    if(res.data && res.data.ResponseCollection){
                        console.log("selected unit data",res.data.ResponseCollection);
                        this.setState({cabId:res.data.ResponseCollection,cabData:cabinfo,cabInfoLoading:false})
   ...
   getAllunitIds(newFilter,e){
    ...
    if(e === false){
        this.setState({cabData:[],cabInfoLoading:true, isAllSelected:false,cabId:[],},()=>{
    ...
    addAssociatedCabs(){
      if(this.state.cabId && this.state.cabId.length > 0){
        ...
        postData("Phase/AssociateCabs",obj)
        .then(res=>{
          if(res.data && res.data.ReturnCode === 0){
            for(let i=0;i<this.state.filterVal.length;i++){
              this.state.filterVal[i]="";
              ...
              this.state.filtered=[];
            this.state.cabId = [];
            this.setState({dlgtitle:"Information",message:"Cabs Added Successfully",dlgType:"information",dlgEnable:true,addCab:false,cabId:[],visibleFilters:[]},this.setData(0,"phase"))
          }
        })
      }else{
        ...
        this.setState({dlgtitle:"Information",message:"Please Select Cabs",dlgType:"information",dlgEnable:true,visibleFilters:[]})
      }
    ...
    beforeCabDelete(){
        if(this.state.cabId && this.state.cabId.length > 0){
            ...
            this.setState({dlgtitle:"Information",message:"Please Select Cabs",dlgType:"information",dlgEnable:true,loading:false})
        }
    }
    ...
    deleteCabs(){
      if(this.state.cabId && this.state.cabId.length > 0){
        ...
        postData("Phase/deletePhaseAssociateCabs",obj)
        .then(res=>{
          if(res.data && res.data.ReturnCode === 0){
            this.setState({dlgtitle:"Information",message:"Cabs Deleted Successfully",dlgType:"information",dlgEnable:true,addCab:false,cabId:[],data:[]},this.setData(0,"release"))
          }
        })
      }else{
        this.setState({dlgtitle:"Information",message:"Please Select Cabs",dlgType:"information",dlgEnable:true,loading:false})
    ...
    getdisabledFun(){
        if(this.state.addType=="Edit Release" || this.state.addType=="Edit Phase"){
            return true;
        }else{
            return false;
        }
    ...
    fetchAssociatedCabs(){
      this.setState({data:[]})
      postData(this.state.cabUrl,this.cabObj)
      .then((res)=>{
        this.rowClick =false
        if(res && res.data && res.data.ResponseCollection){

          this.setState({data:res.data.ResponseCollection,AsscttotalCnt:res.data.TotalcountOfItems,AssctfilterCnt:res.data.FilteredCount,loading:false,AssctpageCount:Math.ceil(res.data.TotalcountOfItems/100)})
        }else{
          this.setState({data:[],loading:false})
        }
      })
    ...
    setAddCabPopup(){
      ...
      this.setState({addCab:false,visibleFilters:[],cabId:[],cabData:[],filtered:[]})
    }
    ...
    getDataforExport(newFilter) {
        console.log("call getDataforExport",this.state.phaseSelected);
            ...
            if(this.state.phaseSelected){
                ...
                postData("Phase/FetchAssociatedCabsExport",this.cabObj)
                    .then((res)=>{
                        this.rowClick =false
                        if(res && res.data && res.data.ResponseCollection){
                            this.callServerExport(res.data.ResponseCollection, this.state.exportFileName,this.state.columns,true)

                        }
                    })
            }else{
                console.log("release selected");
                postData("ScheduleRelease/FetchReleaseAssociatedCabsExport",this.cabObj)
                    .then((res)=>{
                        this.rowClick =false
                        if(res && res.data && res.data.ResponseCollection){
                            this.callServerExport(res.data.ResponseCollection, this.state.exportFileName,this.state.columns,true)
    ...
    getExportDataForReports(){
        ...
        this.callServerExport(myData,this.state.exportFileName,this.state.columns,true);
    }
           ...
           <div>
                 ...
                 <div  className="TableBorder">
                {
                  ...
                  <div className="Loader">
                     <div className="SystemFlupldWrp">
                       <div className="ForgPassTitle">Upload System File</div>
                        <div className={this.state.isSysFileForEdit ? "SystemFlUpldInptWrp disableDiv" : "SystemFlUpldInptWrp"}>
                          <span className="SystemFlUpldtxt" style={{marginLeft:"2%"}}>System File *</span>
                          <input className="SystFlUpldinpt" disabled={true} value={this.state.systFile && this.state.systFile[0] && this.state.systFile[0].name}></input>
                          <input type="file" accept={this.allowedSysFileType} style={{display:"none"}} ref={(myRef)=>this.syStFlupld=myRef} onChange={(e)=>this.onFileChange(e,'system')}></input>
                          <img src={require("../../../Assets/Images/Media/select-files.png")} className="SystFlUpldSelImg" onClick={()=>this.syStFlupld.click()}></img>
                          {
                            this.state.systProg ?
                               <div style={{display:"flex",alignItems:"center",width:"30%",height:"20px"}}>
                                 <Line percent={this.state.systProgCnt} strokeWidth="1" strokeColor="#80BBD7" trailColor="#FFFFFF" className="SystUProgress"/>
                                 <span className="SystProgCnt">{this.state.systProgCnt}%</span>
                               </div>
                              :
                              <img src={require("../../../Assets/Images/Media/upload-btn-popup.png")} className="SystFlUpldSelImg" onClick={()=>this.upLoadFiles("system")}></img>

                          }
                        </div>
                        <div className="SystemFlUpldInptWrp">
                          <span className="SystemFlUpldtxt" style={{marginLeft:"3%"}}>Discription *</span>
                          <textarea className="SystFlUpldinpt1" value={this.state.desc} onChange={(e)=>this.setState({desc:e.target.value})}></textarea>
                        </div>
                        <div className={this.state.isSysFileForEdit || this.state.disbleRelease ? "SystemFlUpldInptWrp1 disableDiv" :"SystemFlUpldInptWrp"} >
                          <span className="SystemFlUpldtxt">Relaese Note *</span>
                          <input className="SystFlUpldinpt" disabled={true} value={this.state.relFile && this.state.relFile[0] && this.state.relFile[0].name}></input>
                          <input type="file" accept={this.allowedRelNoteFileType} style={{display:"none"}} ref={(myRef)=>this.relFlUpld=myRef} onChange={(e)=>this.onFileChange(e,'release')}></input>
                          <img src={require("../../../Assets/Images/Media/select-files.png")} className="SystFlUpldSelImg" onClick={()=>this.relFlUpld.click()}></img>
                          {
                            this.state.relProg ?
                               <div style={{display:"flex",alignItems:"center",width:"30%",height:"20px"}}>
                                 <Line percent={this.state.relProgCnt} strokeWidth="1" strokeColor="#80BBD7" trailColor="#FFFFFF" className="SystUProgress"/>
                                 <span className="SystProgCnt">{this.state.relProgCnt}%</span>
                               </div>
                              :
                              <img src={require("../../../Assets/Images/Media/upload-btn-popup.png")} className="SystFlUpldSelImg" onClick={()=>this.upLoadFiles("release")}></img>

                          }
                        </div>
                        <div className="SystemFlUpldInptWrp">
                          <span className="SystemFlUpldtxt" style={{marginLeft:"4%"}}>End Date *</span>
                          <DatePicker selected={this.state.endDate}   onChange={(date)=>this.setState({endDate:date})}  wrapperClassName="SystDatePickWrp" className="DatePickInptWrp" popperPlacement="right-start"></DatePicker>
                        </div>
                        <div className="SystemFlUpldInptWrp">
                          <span className="SystemFlUpldtxt" style={{marginLeft:"6%"}}>Priority *</span>
                          <select className="SystDropDwn1" onChange={(e)=>this.setState({priority:e.target.value})} value={this.state.priority}>
                        ...
                        </div>
                         {
                             this.marketid=="MX925"?
                                 <div className="SystemFlUpldInptWrp">
                                     <span className="SystemFlUpldtxt" style={{marginLeft:"4%"}}>Unit Type *</span>

                                             <div style={{marginLeft:"1%"}}><ComCheck checked={this.getUnitTYpeforEdit("MX")} containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"} label={"MX"} onChange={()=>this.setUnit("MX")}></ComCheck></div>
                                 ...
                                 <div className="SystemFlUpldInptWrp">
                                     <span className="SystemFlUpldtxt" style={{marginLeft:"4%"}}>Unit Type *</span>
                                             ...
                                             <div style={{marginLeft:"1%"}}><ComCheck checked={this.getUnitTYpeforEdit("TREK")} containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"} label={"TREK"} onChange={()=>this.setUnit("TREK")}></ComCheck></div>
                                             <div style={{marginLeft:"2%"}}><ComCheck checked={this.getUnitTYpeforEdit("M10")} containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"} label={"M10"} onChange={()=>this.setUnit("M10")}></ComCheck></div>
                        ...
                        <div className="MediaFlUpldBtm">
                                <img src={require("../../../Assets/Images/Media/next-btn.png")} className="SystFlnextBtn" onClick={()=>this.addSystemFile()}></img>
                                <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="SystFlnextBtn" onClick={()=>this.setState({upload:false,systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0,isSysFileForEdit:false,selectedRowData:null})}></img>
                        </div>
                     </div>
                     {
                             this.state.uploadVal &&
                            <Dialog title={this.state.dlgtitle} message={this.state.message} onOk={()=>this.setState({uploadVal:false})} onHide={()=>this.setState({uploadVal:false})}/>
                          }
                  </div>
                  : this.state.sucUpld ?
                   <div className="Loader">
                     <div className="SystemFlupldWrp1">
                        ...
                        />
                         <div className="MediaFlUpldBtm">
                                <img src={require("../../../Assets/Images/System/previous.png")} className="SystFlnextBtn" onClick={()=>this.setState({sucUpld:false,upload:true})}></img>
                                <img src={require("../../../Assets/Images/Login/ok-btn.png")} className="SystFlnextBtn" onClick={()=>this.editSystemFile()}></img>
                                <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="SystFlnextBtn" onClick={()=>this.setState({sucUpld:false,systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0,isSysFileForEdit:false,selectedRowData:null})}></img>
                        </div>
                     </div>
                   ...
                   <div className="Loader">
                     <div className="SystemFlupldWrp1">
                        ...
                        <ReactTable
                          columns={this.verColumn}
                          data={this.state.selectedRowData.arrVersionInfoVO?this.state.selectedRowData.arrVersionInfoVO:[]}
                          showPagination={false}
                          sortable={false}
                          NoDataComponent={()=>null}
                          style={{height:"120px"}}
                        ...
                        />
                         <div className="MediaFlUpldBtm">
                                <img src={require("../../../Assets/Images/System/previous.png")} className="SystFlnextBtn" onClick={()=>this.setState({editSucessCrt:false,upload:true})}></img>
                                <img src={require("../../../Assets/Images/Login/ok-btn.png")} className="SystFlnextBtn" onClick={()=>this.editSystemFile()}></img>
                                <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="SystFlnextBtn" onClick={()=>this.setState({selectedCriteriaArr:[],editSucessCrt:false,systFile:[],relFile:[], desc:"",endDate:new Date(), priority:"", uType:[],systProgCnt:0,systProg:false,relProg:false,relProgCnt:0,isSysFileForEdit:false,selectedRowData:null})}></img>
                        </div>
                     </div>
                  ...
                  this.state.dlgEnable ?
                    <Dialog title={this.state.dlgtitle} message={this.state.message} onOk={()=>{
                      if(this.state.dlgType === "Information" || this.state.dlgType === "information"){
                        this.setState({dlgEnable:false})
                          if(this.state.subTabIndex !== 1){
                              this.getRecords("SystemFile/Fetch");
                          }
                      }else if(this.state.dlgType === "deleteCab" || this.state.dlgType === "DeleteCab"){
                            this.deleteCabs();
                      }else{
                        this.deleteFile("delete")
                      }
                    }} onCancel={()=>this.setState({dlgEnable:false})} type={this.state.dlgType} onHide={()=>this.setState({dlgEnable:false})}></Dialog>
                  : this.state.addFile ?
                  <div className="Loader">
                    <div className="SystemAddRelWrp">
                  <div className="ForgPassTitle">{this.state.addType}</div>
                      <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                  <span className="SystemFlUpldtxt" style={{marginLeft:"2%"}}>{this.state.addType === "Add Release" || this.state.addType === "Edit Release" ?"Release":"Phase"} Name *</span>
                          <input style={{width:"50%"}} disabled={this.getdisabledFun()} className="SystFlUpldinpt" value={this.state.relName} onChange={(e)=>this.setState({relName:e.target.value})}></input>
                      </div>

                      {
                        this.state.addType === "Add Release" || this.state.addType === "Edit Release" ?
                        <div>
                              <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                <span className="SystemFlUpldtxt" style={{marginLeft:"6%"}}>System File *</span>

                                  {
                                      this.state.addType === "Edit Release" ?
                                          <div className="editsysfile">{this.getsysfileNameOfRelease()}</div>
                                          :

                                          <select disabled={this.getdisabledFun()}  className="SystDropDwn1" style={{width:"50%"}} defaultValue="" onChange={(e)=>this.setState({systName:this.listOption[e.target.value].lable,systId:this.listOption[e.target.value].value})}>
                               ...
                               <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                  <span className="SystemFlUpldtxt" style={{marginLeft:"8%"}}>Start Date *</span>
                                  <DatePicker selected={this.state.strDate}   onChange={(date)=>this.setState({strDate:date})}  wrapperClassName="SystRelDatePickWrp" className="DatePickInptWrp" popperPlacement="right-start"></DatePicker>
                              </div>
                               <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                  <span className="SystemFlUpldtxt" style={{marginLeft:"8.5%"}}>End Date *</span>

                                  <DatePicker selected={this.state.strEndDate}   onChange={(date)=>this.setState({strEndDate:date})}  wrapperClassName="SystRelDatePickWrp" className="DatePickInptWrp" popperPlacement="right-start"></DatePicker>
                                </div>
                        ...
                        <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                           <span className="SystemFlUpldtxt" style={{marginLeft:"8.5%"}}>Time Start *</span>
                          <input className="SchedBnrPopinpt1" type="number" value={this.state.strHour} onChange={(e)=>this.setState({strHour:e.target.value})}></input>
                          <input className="SchedBnrPopinpt1" type="number" value={this.state.strMin} onChange={(e)=>this.setState({strMin:e.target.value})}></input>
                         </div>
                         <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                           <span className="SystemFlUpldtxt" style={{marginLeft:"14%"}}>Status *</span>
                           <select className="SystDropDwn1" onChange={(e)=>this.setState({status:e.target.value})} value={this.state.status} >
                       ...
                       <div className="SystFlUpldBtm">
                                        <img src={require("../../../Assets/Images/Login/ok-btn.png")} className="SystFlnextBtn" onClick={()=>this.uploadRelease()}></img>
                                        <img src={require("../../../Assets/Images/Login/cancel-btn.png")} className="SystFlnextBtn" onClick={()=>this.setState({addFile:false,systName:"",relName:""})}></img>
                        </div>
                  ...
                  : this.state.addCab &&
                          ...
                          <div className="ScheduleTabToolWrp" style={{"background-color":"#CECECE"}}>
                              <div id="addcabbtncontainer" className="popsubhead">
                                  <div className="rt-td" aria-disabled={true}>
                                      <ComCheck  onChange={(e)=>this.getAllunitIds(this.state.filtered,e)}  containerStyle={"ComCheckMainWrp"} tickStyle={"SchedCheckTick"}></ComCheck>
                                  </div>
                                  <div >
                              ...
                              <div className="ScheduleTableToolCont">
                                  ...
                                  <ExportCSV csvData={this.state.cabData} fileName="schedulecabs" visibleCol={this.state.availableCabsColumns} isConversion={false} callback={()=>{}} />
                                  <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                                  <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getAvailavleCabsListForAssociation(this.state.filtered,'refresh')}></img>
                              </div>
                          </div>
                        <ReactTable
                    ...
                    <span className="SystCabCount">Selected cabs({this.state.cabId.length}/{this.state.filterCnt})</span>
                               <div className="SystAddCabBtn" onClick={()=>this.addAssociatedCabs()}><span>Associate Cabs</span></div>
                               <div className="SystAddCabBtn" onClick={()=>this.setAddCabPopup()}><span>Cancel</span></div>
                            </div>
                      </div>
                  </div>
                }
                 {
                     ...
                     <div id="container" contextMenu="none" onContextMenu={(e)=> e.preventDefault()}>
                             ...
                             this.state.rightAction > 0 ?
                                 <div className="actionMenu" style={{top:`${this.state.y}px`,left:`${this.state.x}px`}}>
                                     <ul className="actionUl" style={{"list-style":"none"}}>
                                         <li>
                                             <div onClick={()=>this.getCabsListForscheduleFile()}>Schedule File</div>
                                         </li>
                                     </ul>
                                 </div>:<div></div>
                        ...
                        <div className="ScheduleTabToolWrp">
                          <img src={require('../../../Assets/Images/Upload/upload-btn.png')} className="ScheduleupldImg" onClick={()=>this.openUploadSysFilePopup()}></img>
                          <img src={require('../../../Assets/Images/Upload/delete.png')} className="ScheduleupldImg" onClick={()=>this.deleteFile("confirm")}></img>
                          ...
                          <div className="ScheduleTableToolCont">
                              ...
                              <img src={require('../../../Assets/Images/tools/show-coloumn.png')} className="ScheduleToolImg" onClick={()=>this.setState({columnSt:!this.state.columnSt})}></img>
                              <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                              <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getRecords("SystemFile/Fetch")}></img>
                          </div>
                        </div>
                          <ReactTable
                                      ...
                                      if (rowInfo && rowInfo.row) {
                                          return {
                                              onContextMenu: (e) => {
                                                  ...
                                                  this.setState({rightAction:1, x: e.screenX, y: e.screenY-50,visibleFilters:[]});
                                              ...
                                              onDoubleClick:(e)=>{
                                                  console.log("double click clikc rowdata",rowInfo.original)
                                                  this.state.selectedRowData = rowInfo.original;
                                                  this.opneeditSysFilePopup();
                                              },
                                              style:{
                                                background:this.sysetmSelected === rowInfo.index?"#00afec":""
                                              }
                              ...
                              />
                         {
                             this.state.isSysfileSchedule ?
                                 <div className="Loader">
                                     <div className="MediaUpldMainWrp" id="divPopupOnscheduleCabFroSystemFile">
                                         <div className="ForgPassTitle">Schedule System File</div>
                                         <div className="ScheduleTabToolWrp" style={{"background-color":"#CECECE"}}>
                                             <div id="addcabbtncontainer" className="popsubhead">
                                                    <div>File Name :</div>
                                             ...
                                             <div className="ScheduleTableToolCont">
                                                 <img src={require('../../../Assets/Images/tools/show-coloumn.png')} className="ScheduleToolImg" onClick={()=>this.setState({columnSt:!this.state.columnSt})}></img>
                                                 <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                                                 <ExportCSV csvData={this.state.ScheduleCabList} fileName="schedulefiletocabs" visibleCol={this.state.ScheduleColumns} isConversion={false} callback={()=>{}} />
                                                 <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                                                 <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.getCabsListForscheduleFile()}></img>
                                             </div>
                                         </div>
                                          ...
                                          <ReactTable
                                                          ...
                                                          manual
                                                          onFetchData={(state, instance) => {
                                                              this.setState({page:instance.state.page},()=> this.getCabsListForscheduleFile(this.state.filtered))
                                              ...
                                              />
                                         <div className="MediaFlUpldBtm">
                                             <span className="SystCabCount">Selected cabs({this.state.cabId.length}/{this.state.cabCount})</span>
                                             <div className="SystAddCabBtn" onClick={()=>this.scheduleSysFileToCab()}><span>Schedule File</span></div>
                                             <div className="SystAddCabBtn" onClick={()=>this.cancleSchedule()}><span>Cancel</span></div>
                                         </div>
                                     </div>
                                 </div>
                                 :<div></div>
                            ...
                            <div style={{display:"inline-flex","width":"100%"}}>
                               <div className="SystGrpWrp" style={{"width":"26%"}}>
                                <div className="SchedGrpTableToolWrp">
                                   <div>
                                       <img src={require("../../../Assets/Images/Group/add-over.png")} className="SchedGrpTableToolImg" onClick={()=>this.openAddReleasePopUp("Add Release")}></img>
                                   </div>
                                    <div>
                                        <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                                    </div>
                                    <div className="releaseRefresh">
                                        <img src={require("../../../Assets/Images/tools/refresh.png")} className="SchedGrpTableToolImg" onClick={()=>this.getReleaseData()}></img>
                                    </div>


                                </div>
                                  <ReactTable
                                              ref={(refReactgrpTable) => {this.refReactgrpTable = refReactgrpTable;}}
                                              ...
                                              getTrGroupProps={(state, rowInfo, column, instance) => {
                                                  if (typeof rowInfo !== "undefined") {
                                                      return {
                                                          ...
                                                          style: {
                                                              background: rowInfo.index === this.state.releaseSelectedindex ? '#00afec' : '',
                                                              color: rowInfo.index === this.state.releaseSelectedindex ? 'white' : 'black'
                                                          },
                                                          onDoubleClick: () => {
                                              ...
                                              onFetchData={(state, instance) => {
                                                let start = (instance.state.page*20);
                                                  ...
                                                  this.setState({loading:true});
                                                  getData("ScheduleRelease/FetchScheduleReleaseWithPagination/"+start+"/"+end)
                                                  .then((res)=>{
                                                    if(res && res.data && res.data.ResponseCollection){
                                                        this.setState({loading:false});
                                                        this.setState({releaseData:res.data.ResponseCollection,grtotalCnt:res.data.TotalcountOfItems,grfilterCnt:res.data.FilteredCount,loading:false,grpageCount:Math.ceil(res.data.TotalcountOfItems/20)},()=>this.setSubTab(this.state.subTabIndex))
                                                    }else{
                                              ...
                                              SubComponent={(rowInfo) => rowInfo.original.childrens !== null?<ReactTable
                                                data={this.state.releaseData.length> 0 ? this.state.releaseData[rowInfo.index].childrens:[]}
                                                ...
                                                getTrGroupProps={(state, rowInfo, column, instance) => {
                                                    if (typeof rowInfo !== "undefined") {
                                                        return {
                                                            ...
                                                            style: {
                                                                background: rowInfo.index === this.state.phaseSelectedindex ? '#00afec' : '',
                                                                color: rowInfo.index === this.state.phaseSelectedindex ? 'white' : 'black'
                                                            },
                                                            onDoubleClick: (e) => {
                                ...
                                <div style={{width:"78%"}}>
                                        <div className="CabDtTabMainWrp">
                                          {
                                            ...
                                            <div className={this.state.subTabIndex === index ?"CabDtTabWrp1":"CabDtTabWrp"} onClick={()=>this.setSubTab(index)}>{key}</div>
                                            ))
                                          }
                                        </div>
                                        {
                                          this.state.subTabIndex === 2 ?
                                              <div>
                                                  <div className="ScheduleTabToolWrp">
                                                      <div className="ScheduleTableToolCont">
                                                          {/*<img src={require('../../../Assets/Images/tools/filter-ico.png')} className="ScheduleToolImg"></img>*/}
                                                          <img src={require("../../../Assets/Images/tools/export.jpg")} className="ScheduleToolImg" onClick={()=>this.getExportDataForReports()}></img>                                                          <img src={require("../../../Assets/Images/separator.png")} className="SchedTopCredSeprtr"></img>
                                                          <img src={require('../../../Assets/Images/tools/refresh.png')} className="ScheduleToolImg" onClick={()=>this.refreshReportData()}></img>
                                                      </div>
                                                  </div>
                                          ...
                                          <div className="ScheduleTabToolWrp">
                                              {
                                                  ...
                                                  <img src={require('../../../Assets/Images/Cab/Add-Cab.png')} className="ScheduleupldImg addCabbtn" onClick={()=>this.getAvailavleCabsListForAssociation([])}></img>
                                                  <img src={require('../../../Assets/Images/Cab/Delete-Cab.png')} className="ScheduleupldImg addCabbtn" onClick={()=>this.beforeCabDelete()}></img>
                                                  </div>
                                                      : <div></div>
                                              }
                                            ...
                                            onFetchData={(state, instance) => {
                                                ...
                                                if(this.state.visibleFilters && this.state.visibleFilters.length>0){
                                                   clearTimeout(this.timer);
                                                   this.timer=setTimeout(()=>this.fetchAssociatedCabs(),650)
                                                }else{
                                     ...
                                     <div className="SystFlDtWrp">
                                       <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                            <span className="SystemFlUpldtxt" style={{marginLeft:"3.5%"}}>System File</span>
                                            <input className="SystFlUpldinpt" value={this.state.releaseData.length > 0 ?this.state.releaseData[this.state.fileIndex].systemFileVO.FileName:""}></input>
                                            <span className="SystemFlUpldtxt" style={{marginLeft:"2%"}}>Release Note</span>
                                            <input className="SystFlUpldinpt" value={this.state.releaseData.length > 0 ?this.state.releaseData[this.state.fileIndex].systemFileVO.ReadMeFileName:""}></input>
                                       </div>
                                       <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                            <span className="SystemFlUpldtxt" style={{marginLeft:"4%"}}>Description</span>
                                            <textarea className="SystFlDtxtArea" value={this.state.releaseData.length > 0 ?this.state.releaseData[this.state.fileIndex].systemFileVO.Description:""}></textarea>
                                       </div>
                                       <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                            <span className="SystemFlUpldtxt" style={{marginLeft:"2%"}}>Release End Date</span>
                                            <input className="SystFlUpldinpt" value={this.state.releaseData.length > 0 ?this.state.releaseData[this.state.fileIndex].systemFileVO.ExpDate:""}></input>
                                       </div>
                                       <div style={{display:"flex",alignItems:"center",marginTop:"6px"}}>
                                            <span className="SystemFlUpldtxt" style={{marginLeft:"7.5%"}}>Priority</span>
                                            <input className="SystFlUpldinpt" value={this.state.releaseData.length > 0 ?priorityCnt[this.state.releaseData[this.state.fileIndex].systemFileVO.PrID]:""}></input>
                                       </div>
                                       <div style={{display:"flex",alignItems:"center",marginTop:"10px",marginLeft:"12px",width:"89%",borderBottom:"2px solid #FFFFFF",paddingBottom:"7px"}}>
                                            <span className="SystFlDtTabHeadtxt" >Version</span>
                                       </div>
                                       <ReactTable
                                            data={this.state.releaseData.length > 0 && this.state.releaseData[this.state.fileIndex].systemFileVersionVOs ?this.state.releaseData[this.state.fileIndex].systemFileVersionVOs : []}
                                        ...
                                        />
                                         <div style={{display:"flex",alignItems:"center",marginTop:"10px",marginLeft:"12px",width:"89%",borderBottom:"2px solid #FFFFFF",paddingBottom:"7px"}}>
                                            <span className="SystFlDtTabHeadtxt" >Success Criteria</span>
                                       </div>
                                       <ReactTable
                                            data={this.state.releaseData.length > 0 && this.state.releaseData[this.state.fileIndex].systemFileCriteriaVOs ?this.state.releaseData[this.state.fileIndex].systemFileCriteriaVOs : []}
